...
- `sdk/go/` — Go bindings, module `github.com/ubiquex/ubx-sdk-kubernetes/sdk/go/v2`
  (a subdirectory Go module, tagged `sdk/go/vX.Y.Z`)
- `sdk/typescript/` — TypeScript bindings, published to npm as `@ubx/sdk-kubernetes`
...
- Three independent registries, three independent version numbers per
  ...
  repos/Ubiquex/ubx-sdk-kubernetes/tags`), `npmjs.com/package/@ubx/sdk-kubernetes`,
