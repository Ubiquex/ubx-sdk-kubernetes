...
class FlowSchemaList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class FlowSchemaList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class FlowSchemaList_Items_Metadata:
...
@dataclasses.dataclass
class FlowSchemaList_Items_Spec_DistinguisherMethod:
    type: Any = None

@dataclasses.dataclass
class FlowSchemaList_Items_Spec_PriorityLevelConfiguration:
    name: Any = None

@dataclasses.dataclass
class FlowSchemaList_Items_Spec_Rules_NonResourceRules:
    non_resource_urls: Any = None
    verbs: Any = None

@dataclasses.dataclass
class FlowSchemaList_Items_Spec_Rules_ResourceRules:
    api_groups: Any = None
...
@dataclasses.dataclass
class FlowSchemaList_Items_Spec_Rules_Subjects_ServiceAccount:
    name: Any = None
    namespace: Any = None

@dataclasses.dataclass
class FlowSchemaList_Items_Spec_Rules_Subjects:
    group: Any = None
    kind: Any = None
...
@dataclasses.dataclass
class FlowSchemaList_Items_Spec_Rules:
    non_resource_rules: Any = None
    resource_rules: Any = None
    subjects: Any = None

@dataclasses.dataclass
class FlowSchemaList_Items_Spec:
...
@dataclasses.dataclass
class FlowSchemaList_Items_Status_Conditions:
...
@dataclasses.dataclass
class FlowSchemaList_Items_Status:
    conditions: Any = None

@dataclasses.dataclass
class FlowSchemaList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class FlowSchemaList_Metadata_ShardInfo:
...
FlowSchemaList = ubx.DataSourceBinding(
    wire_type="kubernetes_flowcontrol_flow_schema_list",
    fields={
