...
class PriorityLevelConfigurationList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class PriorityLevelConfigurationList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class PriorityLevelConfigurationList_Items_Metadata:
...
@dataclasses.dataclass
class PriorityLevelConfigurationList_Items_Spec_Exempt:
    lendable_percent: Any = None
    nominal_concurrency_shares: Any = None

@dataclasses.dataclass
class PriorityLevelConfigurationList_Items_Spec_Limited_LimitResponse_Queuing:
    hand_size: Any = None
    queue_length_limit: Any = None
    queues: Any = None

@dataclasses.dataclass
class PriorityLevelConfigurationList_Items_Spec_Limited_LimitResponse:
    queuing: Any = None
    type: Any = None

@dataclasses.dataclass
class PriorityLevelConfigurationList_Items_Spec_Limited:
...
@dataclasses.dataclass
class PriorityLevelConfigurationList_Items_Spec:
    exempt: Any = None
    limited: Any = None
    type: Any = None

@dataclasses.dataclass
class PriorityLevelConfigurationList_Items_Status_Conditions:
...
@dataclasses.dataclass
class PriorityLevelConfigurationList_Items_Status:
    conditions: Any = None

@dataclasses.dataclass
class PriorityLevelConfigurationList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class PriorityLevelConfigurationList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class PriorityLevelConfigurationList_Metadata:
...
@dataclasses.dataclass
class PriorityLevelConfigurationListConfig:
...
@dataclasses.dataclass
class PriorityLevelConfigurationListAttrs:
    allow_watch_bookmarks: Any = None
...
PriorityLevelConfigurationList = ubx.DataSourceBinding(
    wire_type="kubernetes_flowcontrol_priority_level_configuration_list",
    fields={
