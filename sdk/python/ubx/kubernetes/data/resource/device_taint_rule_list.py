...
class DeviceTaintRuleList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class DeviceTaintRuleList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class DeviceTaintRuleList_Items_Metadata:
...
@dataclasses.dataclass
class DeviceTaintRuleList_Items_Spec_DeviceSelector:
    device: Any = None
    driver: Any = None
    pool: Any = None

@dataclasses.dataclass
class DeviceTaintRuleList_Items_Spec_Taint:
    effect: Any = None
    key: Any = None
    time_added: Any = None
    value: Any = None
...
@dataclasses.dataclass
class DeviceTaintRuleList_Items_Spec:
    device_selector: Any = None
    taint: Any = None

@dataclasses.dataclass
class DeviceTaintRuleList_Items_Status_Conditions:
...
@dataclasses.dataclass
class DeviceTaintRuleList_Items_Status:
    conditions: Any = None

@dataclasses.dataclass
class DeviceTaintRuleList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class DeviceTaintRuleList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class DeviceTaintRuleList_Metadata:
...
@dataclasses.dataclass
class DeviceTaintRuleListConfig:
...
@dataclasses.dataclass
class DeviceTaintRuleListAttrs:
    allow_watch_bookmarks: Any = None
...
DeviceTaintRuleList = ubx.DataSourceBinding(
    wire_type="kubernetes_resource_device_taint_rule_list",
    fields={
