...
class DeviceClassList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class DeviceClassList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class DeviceClassList_Items_Metadata:
...
@dataclasses.dataclass
class DeviceClassList_Items_Spec_Config_Opaque:
    driver: Any = None
    parameters: Any = None

@dataclasses.dataclass
class DeviceClassList_Items_Spec_Config:
    opaque: Any = None

@dataclasses.dataclass
class DeviceClassList_Items_Spec_Selectors_Cel:
    expression: Any = None

@dataclasses.dataclass
class DeviceClassList_Items_Spec_Selectors:
    cel: Any = None

@dataclasses.dataclass
class DeviceClassList_Items_Spec:
    config: Any = None
    extended_resource_name: Any = None
    selectors: Any = None

@dataclasses.dataclass
class DeviceClassList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class DeviceClassList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class DeviceClassList_Metadata:
...
DeviceClassList = ubx.DataSourceBinding(
    wire_type="kubernetes_resource_device_class_list",
    fields={
