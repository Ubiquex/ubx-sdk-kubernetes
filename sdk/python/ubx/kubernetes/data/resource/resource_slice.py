...
class ResourceSlice_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ResourceSlice_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ResourceSlice_Items_Metadata:
...
@dataclasses.dataclass
class ResourceSlice_Items_Spec_Devices_Attributes:
    bool: Any = None
    bools: Any = None
    int: Any = None
    ints: Any = None
...
@dataclasses.dataclass
class ResourceSlice_Items_Spec_Devices_Capacity_RequestPolicy_ValidRange:
    max: Any = None
    min: Any = None
    step: Any = None

@dataclasses.dataclass
class ResourceSlice_Items_Spec_Devices_Capacity_RequestPolicy:
    default: Any = None
    valid_range: Any = None
    valid_values: Any = None

@dataclasses.dataclass
class ResourceSlice_Items_Spec_Devices_Capacity:
    request_policy: Any = None
    value: Any = None

@dataclasses.dataclass
class ResourceSlice_Items_Spec_Devices_ConsumesCounters_Counters:
    value: Any = None

@dataclasses.dataclass
class ResourceSlice_Items_Spec_Devices_ConsumesCounters:
    compatibility_groups: Any = None
    counter_set: Any = None
    counters: Any = None

@dataclasses.dataclass
class ResourceSlice_Items_Spec_Devices_NodeAllocatableResources_Mapping:
    capacity_key: Any = None
    capacity_multiplier: Any = None
    device_multiplier: Any = None

@dataclasses.dataclass
class ResourceSlice_Items_Spec_Devices_NodeAllocatableResources_Overhead:
    per_container: Any = None
    per_pod: Any = None

@dataclasses.dataclass
class ResourceSlice_Items_Spec_Devices_NodeAllocatableResources:
    mapping: Any = None
    overhead: Any = None

@dataclasses.dataclass
class ResourceSlice_Items_Spec_Devices_NodeSelector_NodeSelectorTerms_MatchExpressions:
    key: Any = None
    operator: Any = None
    values: Any = None

@dataclasses.dataclass
class ResourceSlice_Items_Spec_Devices_NodeSelector_NodeSelectorTerms:
    match_expressions: Any = None
    match_fields: Any = None

@dataclasses.dataclass
class ResourceSlice_Items_Spec_Devices_NodeSelector:
    node_selector_terms: Any = None

@dataclasses.dataclass
class ResourceSlice_Items_Spec_Devices_Taints:
    effect: Any = None
    key: Any = None
    time_added: Any = None
    value: Any = None
...
@dataclasses.dataclass
class ResourceSlice_Items_Spec_Devices:
    all_nodes: Any = None
...
@dataclasses.dataclass
class ResourceSlice_Items_Spec_Pool:
    generation: Any = None
    name: Any = None
    resource_slice_count: Any = None

@dataclasses.dataclass
class ResourceSlice_Items_Spec_SharedCounters:
    counters: Any = None
    name: Any = None

@dataclasses.dataclass
class ResourceSlice_Items_Spec:
    all_nodes: Any = None
    devices: Any = None
    driver: Any = None
    node_name: Any = None
...
@dataclasses.dataclass
class ResourceSlice_Metadata_ShardInfo:
...
ResourceSlice = ubx.DataSourceBinding(
