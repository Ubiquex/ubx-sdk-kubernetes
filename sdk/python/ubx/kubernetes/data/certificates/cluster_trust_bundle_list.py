...
class ClusterTrustBundleList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ClusterTrustBundleList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ClusterTrustBundleList_Items_Metadata:
...
@dataclasses.dataclass
class ClusterTrustBundleList_Items_Spec:
    signer_name: Any = None
    trust_bundle: Any = None

@dataclasses.dataclass
class ClusterTrustBundleList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class ClusterTrustBundleList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class ClusterTrustBundleList_Metadata:
...
@dataclasses.dataclass
class ClusterTrustBundleListConfig:
...
@dataclasses.dataclass
class ClusterTrustBundleListAttrs:
    allow_watch_bookmarks: Any = None
...
ClusterTrustBundleList = ubx.DataSourceBinding(
    wire_type="kubernetes_certificates_cluster_trust_bundle_list",
    fields={
