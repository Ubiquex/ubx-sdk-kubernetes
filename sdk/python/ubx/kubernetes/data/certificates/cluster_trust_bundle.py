...
class ClusterTrustBundle_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ClusterTrustBundle_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ClusterTrustBundle_Items_Metadata:
...
@dataclasses.dataclass
class ClusterTrustBundle_Items_Spec:
    signer_name: Any = None
    trust_bundle: Any = None

@dataclasses.dataclass
class ClusterTrustBundle_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class ClusterTrustBundle_Metadata_ShardInfo:
...
ClusterTrustBundle = ubx.DataSourceBinding(
