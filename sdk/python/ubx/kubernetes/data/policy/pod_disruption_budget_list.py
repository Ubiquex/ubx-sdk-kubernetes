...
class PodDisruptionBudgetList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class PodDisruptionBudgetList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class PodDisruptionBudgetList_Items_Metadata:
...
@dataclasses.dataclass
class PodDisruptionBudgetList_Items_Spec_Selector_MatchExpressions:
    key: Any = None
    operator: Any = None
    values: Any = None

@dataclasses.dataclass
class PodDisruptionBudgetList_Items_Spec_Selector:
    match_expressions: Any = None
    match_labels: Any = None

@dataclasses.dataclass
class PodDisruptionBudgetList_Items_Spec:
...
@dataclasses.dataclass
class PodDisruptionBudgetList_Items_Status_Conditions:
...
@dataclasses.dataclass
class PodDisruptionBudgetList_Items_Status:
    conditions: Any = None
...
@dataclasses.dataclass
class PodDisruptionBudgetList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class PodDisruptionBudgetList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class PodDisruptionBudgetList_Metadata:
...
@dataclasses.dataclass
class PodDisruptionBudgetListConfig:
...
@dataclasses.dataclass
class PodDisruptionBudgetListAttrs:
    allow_watch_bookmarks: Any = None
...
PodDisruptionBudgetList = ubx.DataSourceBinding(
    wire_type="kubernetes_policy_pod_disruption_budget_list",
    fields={
