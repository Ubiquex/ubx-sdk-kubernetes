...
class PodDisruptionBudget_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class PodDisruptionBudget_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class PodDisruptionBudget_Items_Metadata:
...
@dataclasses.dataclass
class PodDisruptionBudget_Items_Spec_Selector_MatchExpressions:
    key: Any = None
    operator: Any = None
    values: Any = None

@dataclasses.dataclass
class PodDisruptionBudget_Items_Spec_Selector:
    match_expressions: Any = None
    match_labels: Any = None

@dataclasses.dataclass
class PodDisruptionBudget_Items_Spec:
...
@dataclasses.dataclass
class PodDisruptionBudget_Items_Status_Conditions:
...
@dataclasses.dataclass
class PodDisruptionBudget_Items_Status:
    conditions: Any = None
...
@dataclasses.dataclass
class PodDisruptionBudget_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class PodDisruptionBudget_Metadata_ShardInfo:
...
PodDisruptionBudget = ubx.DataSourceBinding(
