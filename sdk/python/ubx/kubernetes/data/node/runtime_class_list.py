...
class RuntimeClassList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class RuntimeClassList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class RuntimeClassList_Items_Metadata:
...
@dataclasses.dataclass
class RuntimeClassList_Items_Overhead:
    pod_fixed: Any = None

@dataclasses.dataclass
class RuntimeClassList_Items_Scheduling_Tolerations:
    effect: Any = None
    key: Any = None
    operator: Any = None
...
@dataclasses.dataclass
class RuntimeClassList_Items_Scheduling:
    node_selector: Any = None
    tolerations: Any = None

@dataclasses.dataclass
class RuntimeClassList_Items:
    api_version: Any = None
    handler: Any = None
    kind: Any = None
    metadata: Any = None
...
@dataclasses.dataclass
class RuntimeClassList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class RuntimeClassList_Metadata:
...
RuntimeClassList = ubx.DataSourceBinding(
    wire_type="kubernetes_node_runtime_class_list",
    fields={
