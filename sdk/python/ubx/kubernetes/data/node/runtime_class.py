...
class RuntimeClass_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class RuntimeClass_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class RuntimeClass_Items_Metadata:
...
@dataclasses.dataclass
class RuntimeClass_Items_Overhead:
    pod_fixed: Any = None

@dataclasses.dataclass
class RuntimeClass_Items_Scheduling_Tolerations:
    effect: Any = None
    key: Any = None
    operator: Any = None
...
@dataclasses.dataclass
class RuntimeClass_Items_Scheduling:
    node_selector: Any = None
    tolerations: Any = None

@dataclasses.dataclass
class RuntimeClass_Items:
    api_version: Any = None
    handler: Any = None
    kind: Any = None
    metadata: Any = None
...
@dataclasses.dataclass
class RuntimeClass_Metadata_ShardInfo:
...
RuntimeClass = ubx.DataSourceBinding(
