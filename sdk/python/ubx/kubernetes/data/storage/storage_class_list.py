...
class StorageClassList_Items_AllowedTopologies_MatchLabelExpressions:
    key: Any = None
    values: Any = None

@dataclasses.dataclass
class StorageClassList_Items_AllowedTopologies:
    match_label_expressions: Any = None

@dataclasses.dataclass
class StorageClassList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class StorageClassList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class StorageClassList_Items_Metadata:
...
@dataclasses.dataclass
class StorageClassList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class StorageClassList_Metadata:
...
StorageClassList = ubx.DataSourceBinding(
    wire_type="kubernetes_storage_storage_class_list",
    fields={
