...
class CsinodeList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class CsinodeList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class CsinodeList_Items_Metadata:
...
@dataclasses.dataclass
class CsinodeList_Items_Spec_Drivers_Allocatable:
    count: Any = None

@dataclasses.dataclass
class CsinodeList_Items_Spec_Drivers:
...
@dataclasses.dataclass
class CsinodeList_Items_Spec:
    drivers: Any = None

@dataclasses.dataclass
class CsinodeList_Items_Status_StorageHealth_HealthConditions:
...
@dataclasses.dataclass
class CsinodeList_Items_Status_StorageHealth:
    health_conditions: Any = None
    name: Any = None

@dataclasses.dataclass
class CsinodeList_Items_Status:
    storage_health: Any = None

@dataclasses.dataclass
class CsinodeList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class CsinodeList_Metadata_ShardInfo:
...
CsinodeList = ubx.DataSourceBinding(
    wire_type="kubernetes_storage_csinode_list",
    fields={
