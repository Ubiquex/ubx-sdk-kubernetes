...
class StorageClass_Items_AllowedTopologies_MatchLabelExpressions:
    key: Any = None
    values: Any = None

@dataclasses.dataclass
class StorageClass_Items_AllowedTopologies:
    match_label_expressions: Any = None

@dataclasses.dataclass
class StorageClass_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class StorageClass_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class StorageClass_Items_Metadata:
...
@dataclasses.dataclass
class StorageClass_Metadata_ShardInfo:
...
StorageClass = ubx.DataSourceBinding(
