...
class Csinode_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class Csinode_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class Csinode_Items_Spec_Drivers_Allocatable:
    count: Any = None

@dataclasses.dataclass
class Csinode_Items_Spec_Drivers:
...
@dataclasses.dataclass
class Csinode_Items_Spec:
    drivers: Any = None

@dataclasses.dataclass
class Csinode_Items_Status_StorageHealth_HealthConditions:
...
@dataclasses.dataclass
class Csinode_Items_Status_StorageHealth:
    health_conditions: Any = None
    name: Any = None

@dataclasses.dataclass
class Csinode_Items_Status:
...
@dataclasses.dataclass
class Csinode_Metadata_ShardInfo:
