...
class VolumeAttributesClassList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class VolumeAttributesClassList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class VolumeAttributesClassList_Items_Metadata:
...
@dataclasses.dataclass
class VolumeAttributesClassList_Items:
    api_version: Any = None
...
@dataclasses.dataclass
class VolumeAttributesClassList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class VolumeAttributesClassList_Metadata:
...
@dataclasses.dataclass
class VolumeAttributesClassListConfig:
...
@dataclasses.dataclass
class VolumeAttributesClassListAttrs:
    allow_watch_bookmarks: Any = None
...
VolumeAttributesClassList = ubx.DataSourceBinding(
    wire_type="kubernetes_storage_volume_attributes_class_list",
    fields={
