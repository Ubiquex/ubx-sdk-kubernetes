...
class Csidriver_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class Csidriver_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class Csidriver_Items_Metadata:
...
@dataclasses.dataclass
class Csidriver_Items_Spec_TokenRequests:
    audience: Any = None
    expiration_seconds: Any = None

@dataclasses.dataclass
class Csidriver_Items_Spec:
...
@dataclasses.dataclass
class Csidriver_Metadata_ShardInfo:
...
Csidriver = ubx.DataSourceBinding(
