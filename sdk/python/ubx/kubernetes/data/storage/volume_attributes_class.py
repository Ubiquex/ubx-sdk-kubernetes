...
class VolumeAttributesClass_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class VolumeAttributesClass_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class VolumeAttributesClass_Items_Metadata:
...
@dataclasses.dataclass
class VolumeAttributesClass_Items:
    api_version: Any = None
...
@dataclasses.dataclass
class VolumeAttributesClass_Metadata_ShardInfo:
...
VolumeAttributesClass = ubx.DataSourceBinding(
