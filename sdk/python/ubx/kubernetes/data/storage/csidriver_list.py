...
class CsidriverList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class CsidriverList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class CsidriverList_Items_Metadata:
...
@dataclasses.dataclass
class CsidriverList_Items_Spec_TokenRequests:
    audience: Any = None
    expiration_seconds: Any = None

@dataclasses.dataclass
class CsidriverList_Items_Spec:
...
@dataclasses.dataclass
class CsidriverList_Metadata_ShardInfo:
...
CsidriverList = ubx.DataSourceBinding(
    wire_type="kubernetes_storage_csidriver_list",
    fields={
