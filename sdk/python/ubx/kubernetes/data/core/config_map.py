...
class ConfigMap_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ConfigMap_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ConfigMap_Items_Metadata:
...
@dataclasses.dataclass
class ConfigMap_Metadata_ShardInfo:
...
ConfigMap = ubx.DataSourceBinding(
