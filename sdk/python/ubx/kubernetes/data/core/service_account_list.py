...
class ServiceAccountList_Items_ImagePullSecrets:
    name: Any = None

@dataclasses.dataclass
class ServiceAccountList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ServiceAccountList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ServiceAccountList_Items_Metadata:
...
@dataclasses.dataclass
class ServiceAccountList_Items_Secrets:
    api_version: Any = None
    field_path: Any = None
    kind: Any = None
    name: Any = None
...
@dataclasses.dataclass
class ServiceAccountList_Items:
    api_version: Any = None
...
@dataclasses.dataclass
class ServiceAccountList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class ServiceAccountList_Metadata:
...
@dataclasses.dataclass
class ServiceAccountListConfig:
...
ServiceAccountList = ubx.DataSourceBinding(
    wire_type="kubernetes_core_service_account_list",
    fields={
