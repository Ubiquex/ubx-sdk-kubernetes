...
class NamespaceList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class NamespaceList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class NamespaceList_Items_Metadata:
...
@dataclasses.dataclass
class NamespaceList_Items_Spec:
    finalizers: Any = None

@dataclasses.dataclass
class NamespaceList_Items_Status_Conditions:
...
@dataclasses.dataclass
class NamespaceList_Items_Status:
    conditions: Any = None
    phase: Any = None

@dataclasses.dataclass
class NamespaceList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class NamespaceList_Metadata_ShardInfo:
...
NamespaceList = ubx.DataSourceBinding(
    wire_type="kubernetes_core_namespace_list",
    fields={
