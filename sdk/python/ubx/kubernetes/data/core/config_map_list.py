...
class ConfigMapList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ConfigMapList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ConfigMapList_Items_Metadata:
...
@dataclasses.dataclass
class ConfigMapList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class ConfigMapListConfig:
    pass

@dataclasses.dataclass
class ConfigMapListAttrs:
...
ConfigMapList = ubx.DataSourceBinding(
    wire_type="kubernetes_core_config_map_list",
    fields={
    },
)
