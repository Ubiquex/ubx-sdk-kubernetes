...
class ComponentConditionList_Conditions:
    error: Any = None
    message: Any = None
    status: Any = None
    type: Any = None
...
@dataclasses.dataclass
class ComponentConditionList_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ComponentConditionList_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ComponentConditionList_Metadata:
...
@dataclasses.dataclass
class ComponentConditionListConfig:
    pass

@dataclasses.dataclass
class ComponentConditionListAttrs:
...
ComponentConditionList = ubx.DataSourceBinding(
    wire_type="kubernetes_core_component_condition_list",
    fields={
    },
)
