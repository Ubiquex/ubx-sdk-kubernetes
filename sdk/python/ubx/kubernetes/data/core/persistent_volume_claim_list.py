...
class PersistentVolumeClaimList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class PersistentVolumeClaimList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class PersistentVolumeClaimList_Items_Metadata:
...
@dataclasses.dataclass
class PersistentVolumeClaimList_Items_Spec_DataSource:
    api_group: Any = None
    kind: Any = None
    name: Any = None

@dataclasses.dataclass
class PersistentVolumeClaimList_Items_Spec_DataSourceRef:
    api_group: Any = None
    kind: Any = None
    name: Any = None
    namespace: Any = None
...
@dataclasses.dataclass
class PersistentVolumeClaimList_Items_Spec_Resources:
    limits: Any = None
    requests: Any = None

@dataclasses.dataclass
class PersistentVolumeClaimList_Items_Spec_Selector_MatchExpressions:
    key: Any = None
    operator: Any = None
    values: Any = None

@dataclasses.dataclass
class PersistentVolumeClaimList_Items_Spec_Selector:
    match_expressions: Any = None
    match_labels: Any = None

@dataclasses.dataclass
class PersistentVolumeClaimList_Items_Spec:
...
@dataclasses.dataclass
class PersistentVolumeClaimList_Items_Status_Conditions:
...
@dataclasses.dataclass
class PersistentVolumeClaimList_Items_Status_HealthStatus_HealthConditions:
    message: Any = None
    reason: Any = None
    status: Any = None

@dataclasses.dataclass
class PersistentVolumeClaimList_Items_Status_HealthStatus:
    health_conditions: Any = None
    last_transition_time: Any = None

@dataclasses.dataclass
class PersistentVolumeClaimList_Items_Status_ModifyVolumeStatus:
    status: Any = None
    target_volume_attributes_class_name: Any = None

@dataclasses.dataclass
class PersistentVolumeClaimList_Items_Status:
    access_modes: Any = None
...
@dataclasses.dataclass
class PersistentVolumeClaimList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class PersistentVolumeClaimList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class PersistentVolumeClaimList_Metadata:
...
@dataclasses.dataclass
class PersistentVolumeClaimListConfig:
...
@dataclasses.dataclass
class PersistentVolumeClaimListAttrs:
    allow_watch_bookmarks: Any = None
...
PersistentVolumeClaimList = ubx.DataSourceBinding(
    wire_type="kubernetes_core_persistent_volume_claim_list",
    fields={
