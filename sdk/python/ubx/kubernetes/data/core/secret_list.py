...
class SecretList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class SecretList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class SecretList_Items_Metadata:
...
@dataclasses.dataclass
class SecretList_Metadata_ShardInfo:
...
SecretList = ubx.DataSourceBinding(
    wire_type="kubernetes_core_secret_list",
    fields={
