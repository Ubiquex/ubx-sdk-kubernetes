...
class ServiceAccount_Items_ImagePullSecrets:
    name: Any = None

@dataclasses.dataclass
class ServiceAccount_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ServiceAccount_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ServiceAccount_Items_Metadata:
...
@dataclasses.dataclass
class ServiceAccount_Items_Secrets:
    api_version: Any = None
    field_path: Any = None
    kind: Any = None
    name: Any = None
...
@dataclasses.dataclass
class ServiceAccount_Metadata_ShardInfo:
