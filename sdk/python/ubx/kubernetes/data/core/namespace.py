...
class Namespace_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class Namespace_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class Namespace_Items_Metadata:
...
@dataclasses.dataclass
class Namespace_Items_Spec:
    finalizers: Any = None

@dataclasses.dataclass
class Namespace_Items_Status_Conditions:
...
@dataclasses.dataclass
class Namespace_Items_Status:
    conditions: Any = None
    phase: Any = None

@dataclasses.dataclass
class Namespace_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class Namespace_Metadata_ShardInfo:
