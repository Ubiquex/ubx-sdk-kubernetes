...
class ServiceList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ServiceList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ServiceList_Items_Metadata:
...
@dataclasses.dataclass
class ServiceList_Items_Spec_Ports:
...
@dataclasses.dataclass
class ServiceList_Items_Spec_SessionAffinityConfig_ClientIp:
    timeout_seconds: Any = None

@dataclasses.dataclass
class ServiceList_Items_Spec_SessionAffinityConfig:
    client_ip: Any = None

@dataclasses.dataclass
class ServiceList_Items_Spec:
...
@dataclasses.dataclass
class ServiceList_Items_Status_Conditions:
...
@dataclasses.dataclass
class ServiceList_Items_Status_LoadBalancer_Ingress_Ports:
    error: Any = None
    port: Any = None
    protocol: Any = None

@dataclasses.dataclass
class ServiceList_Items_Status_LoadBalancer_Ingress:
    hostname: Any = None
    ip: Any = None
    ip_mode: Any = None
    ports: Any = None
...
@dataclasses.dataclass
class ServiceList_Items_Status_LoadBalancer:
    ingress: Any = None

@dataclasses.dataclass
class ServiceList_Items_Status:
    conditions: Any = None
    load_balancer: Any = None

@dataclasses.dataclass
class ServiceList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class ServiceList_Metadata_ShardInfo:
...
ServiceList = ubx.DataSourceBinding(
    wire_type="kubernetes_core_service_list",
    fields={
