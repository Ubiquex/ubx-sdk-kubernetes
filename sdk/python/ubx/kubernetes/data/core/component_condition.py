...
class ComponentCondition_Conditions:
    error: Any = None
    message: Any = None
    status: Any = None
    type: Any = None
...
@dataclasses.dataclass
class ComponentCondition_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ComponentCondition_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ComponentCondition_Metadata:
...
@dataclasses.dataclass
class ComponentConditionConfig:
    pass

@dataclasses.dataclass
class ComponentConditionAttrs:
...
ComponentCondition = ubx.DataSourceBinding(
    wire_type="kubernetes_core_component_condition",
    fields={
    },
)
