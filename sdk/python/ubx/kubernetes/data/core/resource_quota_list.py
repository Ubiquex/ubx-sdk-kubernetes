...
class ResourceQuotaList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ResourceQuotaList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ResourceQuotaList_Items_Metadata:
...
@dataclasses.dataclass
class ResourceQuotaList_Items_Spec_ScopeSelector_MatchExpressions:
    operator: Any = None
    scope_name: Any = None
    values: Any = None

@dataclasses.dataclass
class ResourceQuotaList_Items_Spec_ScopeSelector:
    match_expressions: Any = None

@dataclasses.dataclass
class ResourceQuotaList_Items_Spec:
    hard: Any = None
    scope_selector: Any = None
    scopes: Any = None

@dataclasses.dataclass
class ResourceQuotaList_Items_Status:
    hard: Any = None
    used: Any = None

@dataclasses.dataclass
class ResourceQuotaList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class ResourceQuotaList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class ResourceQuotaList_Metadata:
...
ResourceQuotaList = ubx.DataSourceBinding(
    wire_type="kubernetes_core_resource_quota_list",
    fields={
