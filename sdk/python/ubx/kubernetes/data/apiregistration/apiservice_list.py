...
class ApiserviceList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ApiserviceList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ApiserviceList_Items_Metadata:
...
@dataclasses.dataclass
class ApiserviceList_Items_Spec_Service:
    name: Any = None
    namespace: Any = None
    port: Any = None

@dataclasses.dataclass
class ApiserviceList_Items_Spec:
    ca_bundle: Any = None
    group: Any = None
...
@dataclasses.dataclass
class ApiserviceList_Items_Status_Conditions:
...
@dataclasses.dataclass
class ApiserviceList_Items_Status:
    conditions: Any = None

@dataclasses.dataclass
class ApiserviceList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class ApiserviceList_Metadata_ShardInfo:
...
ApiserviceList = ubx.DataSourceBinding(
    wire_type="kubernetes_apiregistration_apiservice_list",
    fields={
