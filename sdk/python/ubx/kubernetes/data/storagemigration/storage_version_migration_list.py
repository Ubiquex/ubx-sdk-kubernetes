...
class StorageVersionMigrationList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class StorageVersionMigrationList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class StorageVersionMigrationList_Items_Metadata:
...
@dataclasses.dataclass
class StorageVersionMigrationList_Items_Spec_Resource:
    group: Any = None
    resource: Any = None

@dataclasses.dataclass
class StorageVersionMigrationList_Items_Spec:
    resource: Any = None

@dataclasses.dataclass
class StorageVersionMigrationList_Items_Status_Conditions:
...
@dataclasses.dataclass
class StorageVersionMigrationList_Items_Status:
    conditions: Any = None
    resource_version: Any = None

@dataclasses.dataclass
class StorageVersionMigrationList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class StorageVersionMigrationList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class StorageVersionMigrationList_Metadata:
...
@dataclasses.dataclass
class StorageVersionMigrationListConfig:
...
@dataclasses.dataclass
class StorageVersionMigrationListAttrs:
    allow_watch_bookmarks: Any = None
...
StorageVersionMigrationList = ubx.DataSourceBinding(
    wire_type="kubernetes_storagemigration_storage_version_migration_list",
    fields={
