...
class MutatingAdmissionPolicyBinding_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class MutatingAdmissionPolicyBinding_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class MutatingAdmissionPolicyBinding_Items_Metadata:
...
@dataclasses.dataclass
class MutatingAdmissionPolicyBinding_Items_Spec_MatchResources_ExcludeResourceRules:
    api_groups: Any = None
...
@dataclasses.dataclass
class MutatingAdmissionPolicyBinding_Items_Spec_MatchResources_NamespaceSelector_MatchExpressions:
    key: Any = None
    operator: Any = None
    values: Any = None

@dataclasses.dataclass
class MutatingAdmissionPolicyBinding_Items_Spec_MatchResources_NamespaceSelector:
    match_expressions: Any = None
    match_labels: Any = None

@dataclasses.dataclass
class MutatingAdmissionPolicyBinding_Items_Spec_MatchResources:
...
@dataclasses.dataclass
class MutatingAdmissionPolicyBinding_Items_Spec_ParamRef:
    name: Any = None
    namespace: Any = None
...
@dataclasses.dataclass
class MutatingAdmissionPolicyBinding_Items_Spec:
    match_resources: Any = None
    param_ref: Any = None
    policy_name: Any = None

@dataclasses.dataclass
class MutatingAdmissionPolicyBinding_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class MutatingAdmissionPolicyBinding_Metadata_ShardInfo:
...
MutatingAdmissionPolicyBinding = ubx.DataSourceBinding(
