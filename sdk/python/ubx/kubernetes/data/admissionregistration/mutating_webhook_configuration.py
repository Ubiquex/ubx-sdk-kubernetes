...
class MutatingWebhookConfiguration_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class MutatingWebhookConfiguration_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class MutatingWebhookConfiguration_Items_Metadata:
...
@dataclasses.dataclass
class MutatingWebhookConfiguration_Items_Webhooks_ClientConfig_Service:
    name: Any = None
    namespace: Any = None
    path: Any = None
    port: Any = None
...
@dataclasses.dataclass
class MutatingWebhookConfiguration_Items_Webhooks_ClientConfig:
    ca_bundle: Any = None
    service: Any = None
    url: Any = None

@dataclasses.dataclass
class MutatingWebhookConfiguration_Items_Webhooks_MatchConditions:
    expression: Any = None
    name: Any = None

@dataclasses.dataclass
class MutatingWebhookConfiguration_Items_Webhooks_NamespaceSelector_MatchExpressions:
    key: Any = None
    operator: Any = None
    values: Any = None

@dataclasses.dataclass
class MutatingWebhookConfiguration_Items_Webhooks_NamespaceSelector:
    match_expressions: Any = None
    match_labels: Any = None

@dataclasses.dataclass
class MutatingWebhookConfiguration_Items_Webhooks_Rules:
    api_groups: Any = None
...
@dataclasses.dataclass
class MutatingWebhookConfiguration_Items_Webhooks:
...
@dataclasses.dataclass
class MutatingWebhookConfiguration_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    webhooks: Any = None
...
@dataclasses.dataclass
class MutatingWebhookConfiguration_Metadata_ShardInfo:
...
MutatingWebhookConfiguration = ubx.DataSourceBinding(
