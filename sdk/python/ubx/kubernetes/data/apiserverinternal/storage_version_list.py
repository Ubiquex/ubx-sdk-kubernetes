...
class StorageVersionList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class StorageVersionList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class StorageVersionList_Items_Metadata:
...
@dataclasses.dataclass
class StorageVersionList_Items_Status_Conditions:
...
@dataclasses.dataclass
class StorageVersionList_Items_Status_StorageVersions:
...
@dataclasses.dataclass
class StorageVersionList_Items_Status:
    common_encoding_version: Any = None
    conditions: Any = None
    storage_versions: Any = None

@dataclasses.dataclass
class StorageVersionList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class StorageVersionList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class StorageVersionList_Metadata:
...
@dataclasses.dataclass
class StorageVersionListConfig:
...
StorageVersionList = ubx.DataSourceBinding(
    wire_type="kubernetes_apiserverinternal_storage_version_list",
    fields={
