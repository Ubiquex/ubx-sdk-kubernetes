...
class StorageVersion_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class StorageVersion_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class StorageVersion_Items_Metadata:
...
@dataclasses.dataclass
class StorageVersion_Items_Status_Conditions:
...
@dataclasses.dataclass
class StorageVersion_Items_Status_StorageVersions:
...
@dataclasses.dataclass
class StorageVersion_Items_Status:
    common_encoding_version: Any = None
    conditions: Any = None
    storage_versions: Any = None

@dataclasses.dataclass
class StorageVersion_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class StorageVersion_Metadata_ShardInfo:
...
StorageVersion = ubx.DataSourceBinding(
