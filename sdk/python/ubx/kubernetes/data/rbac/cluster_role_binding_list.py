...
class ClusterRoleBindingList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ClusterRoleBindingList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ClusterRoleBindingList_Items_Metadata:
...
@dataclasses.dataclass
class ClusterRoleBindingList_Items_RoleRef:
    api_group: Any = None
    kind: Any = None
    name: Any = None

@dataclasses.dataclass
class ClusterRoleBindingList_Items_Subjects:
    api_group: Any = None
    kind: Any = None
    name: Any = None
    namespace: Any = None
...
@dataclasses.dataclass
class ClusterRoleBindingList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    role_ref: Any = None
...
@dataclasses.dataclass
class ClusterRoleBindingList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class ClusterRoleBindingList_Metadata:
...
@dataclasses.dataclass
class ClusterRoleBindingListConfig:
...
@dataclasses.dataclass
class ClusterRoleBindingListAttrs:
    allow_watch_bookmarks: Any = None
...
ClusterRoleBindingList = ubx.DataSourceBinding(
    wire_type="kubernetes_rbac_cluster_role_binding_list",
    fields={
