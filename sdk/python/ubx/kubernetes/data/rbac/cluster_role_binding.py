...
class ClusterRoleBinding_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ClusterRoleBinding_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ClusterRoleBinding_Items_Metadata:
...
@dataclasses.dataclass
class ClusterRoleBinding_Items_RoleRef:
    api_group: Any = None
    kind: Any = None
    name: Any = None

@dataclasses.dataclass
class ClusterRoleBinding_Items_Subjects:
    api_group: Any = None
    kind: Any = None
    name: Any = None
    namespace: Any = None
...
@dataclasses.dataclass
class ClusterRoleBinding_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    role_ref: Any = None
...
@dataclasses.dataclass
class ClusterRoleBinding_Metadata_ShardInfo:
...
ClusterRoleBinding = ubx.DataSourceBinding(
