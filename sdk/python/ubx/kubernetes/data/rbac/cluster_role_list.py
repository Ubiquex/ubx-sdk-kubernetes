...
class ClusterRoleList_Items_AggregationRule_ClusterRoleSelectors_MatchExpressions:
    key: Any = None
    operator: Any = None
    values: Any = None

@dataclasses.dataclass
class ClusterRoleList_Items_AggregationRule_ClusterRoleSelectors:
    match_expressions: Any = None
    match_labels: Any = None

@dataclasses.dataclass
class ClusterRoleList_Items_AggregationRule:
    cluster_role_selectors: Any = None

@dataclasses.dataclass
class ClusterRoleList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ClusterRoleList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ClusterRoleList_Items_Metadata:
...
@dataclasses.dataclass
class ClusterRoleList_Items_Rules:
    api_groups: Any = None
...
@dataclasses.dataclass
class ClusterRoleList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class ClusterRoleList_Metadata:
...
ClusterRoleList = ubx.DataSourceBinding(
    wire_type="kubernetes_rbac_cluster_role_list",
    fields={
