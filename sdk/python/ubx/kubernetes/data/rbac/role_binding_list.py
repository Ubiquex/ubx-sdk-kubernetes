...
class RoleBindingList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class RoleBindingList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class RoleBindingList_Items_Metadata:
...
@dataclasses.dataclass
class RoleBindingList_Items_RoleRef:
    api_group: Any = None
    kind: Any = None
    name: Any = None

@dataclasses.dataclass
class RoleBindingList_Items_Subjects:
    api_group: Any = None
    kind: Any = None
    name: Any = None
    namespace: Any = None
...
@dataclasses.dataclass
class RoleBindingList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class RoleBindingList_Metadata:
...
RoleBindingList = ubx.DataSourceBinding(
    wire_type="kubernetes_rbac_role_binding_list",
    fields={
