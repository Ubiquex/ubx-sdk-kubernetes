...
class ClusterRole_Items_AggregationRule_ClusterRoleSelectors_MatchExpressions:
    key: Any = None
    operator: Any = None
    values: Any = None

@dataclasses.dataclass
class ClusterRole_Items_AggregationRule_ClusterRoleSelectors:
    match_expressions: Any = None
    match_labels: Any = None

@dataclasses.dataclass
class ClusterRole_Items_AggregationRule:
    cluster_role_selectors: Any = None

@dataclasses.dataclass
class ClusterRole_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ClusterRole_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ClusterRole_Items_Metadata:
...
@dataclasses.dataclass
class ClusterRole_Metadata_ShardInfo:
...
ClusterRole = ubx.DataSourceBinding(
