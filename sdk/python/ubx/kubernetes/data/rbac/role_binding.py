...
class RoleBinding_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class RoleBinding_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class RoleBinding_Items_Metadata:
...
@dataclasses.dataclass
class RoleBinding_Items_RoleRef:
    api_group: Any = None
    kind: Any = None
    name: Any = None

@dataclasses.dataclass
class RoleBinding_Items_Subjects:
    api_group: Any = None
    kind: Any = None
    name: Any = None
    namespace: Any = None
...
@dataclasses.dataclass
class RoleBinding_Metadata_ShardInfo:
...
RoleBinding = ubx.DataSourceBinding(
