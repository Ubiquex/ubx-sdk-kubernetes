...
class RoleList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class RoleList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class RoleList_Metadata_ShardInfo:
...
RoleList = ubx.DataSourceBinding(
    wire_type="kubernetes_rbac_role_list",
    fields={
