...
class PriorityClass_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class PriorityClass_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class PriorityClass_Items_Metadata:
...
@dataclasses.dataclass
class PriorityClass_Metadata_ShardInfo:
...
PriorityClass = ubx.DataSourceBinding(
