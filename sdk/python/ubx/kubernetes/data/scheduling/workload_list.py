...
class WorkloadList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class WorkloadList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class WorkloadList_Items_Metadata:
...
@dataclasses.dataclass
class WorkloadList_Items_Spec_CompositePodGroupTemplates_CompositePodGroupTemplates:
    pass

@dataclasses.dataclass
class WorkloadList_Items_Spec_CompositePodGroupTemplates_DisruptionMode:
    all: Any = None
    single: Any = None

@dataclasses.dataclass
class WorkloadList_Items_Spec_CompositePodGroupTemplates_PodGroupTemplates_ResourceClaims:
    name: Any = None
    resource_claim_name: Any = None
    resource_claim_template_name: Any = None

@dataclasses.dataclass
class WorkloadList_Items_Spec_CompositePodGroupTemplates_PodGroupTemplates_SchedulingConstraints_Topology:
    key: Any = None

@dataclasses.dataclass
class WorkloadList_Items_Spec_CompositePodGroupTemplates_PodGroupTemplates_SchedulingConstraints:
    topology: Any = None

@dataclasses.dataclass
class WorkloadList_Items_Spec_CompositePodGroupTemplates_PodGroupTemplates_SchedulingPolicy_Gang:
    min_count: Any = None

@dataclasses.dataclass
class WorkloadList_Items_Spec_CompositePodGroupTemplates_PodGroupTemplates_SchedulingPolicy:
    basic: Any = None
    gang: Any = None

@dataclasses.dataclass
class WorkloadList_Items_Spec_CompositePodGroupTemplates_PodGroupTemplates:
...
@dataclasses.dataclass
class WorkloadList_Items_Spec_CompositePodGroupTemplates_SchedulingPolicy_Gang:
    min_group_count: Any = None

@dataclasses.dataclass
class WorkloadList_Items_Spec_CompositePodGroupTemplates_SchedulingPolicy:
    basic: Any = None
    gang: Any = None

@dataclasses.dataclass
class WorkloadList_Items_Spec_CompositePodGroupTemplates:
...
@dataclasses.dataclass
class WorkloadList_Items_Spec_ControllerRef:
    api_group: Any = None
    kind: Any = None
    name: Any = None

@dataclasses.dataclass
class WorkloadList_Items_Spec:
    composite_pod_group_templates: Any = None
    controller_ref: Any = None
    pod_group_templates: Any = None

@dataclasses.dataclass
class WorkloadList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class WorkloadList_Metadata_ShardInfo:
...
WorkloadList = ubx.DataSourceBinding(
    wire_type="kubernetes_scheduling_workload_list",
    fields={
