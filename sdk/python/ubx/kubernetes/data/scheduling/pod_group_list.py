...
class PodGroupList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class PodGroupList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class PodGroupList_Items_Metadata:
...
@dataclasses.dataclass
class PodGroupList_Items_Spec_DisruptionMode:
    all: Any = None
    single: Any = None

@dataclasses.dataclass
class PodGroupList_Items_Spec_ResourceClaims:
    name: Any = None
    resource_claim_name: Any = None
    resource_claim_template_name: Any = None

@dataclasses.dataclass
class PodGroupList_Items_Spec_SchedulingConstraints_Topology:
    key: Any = None

@dataclasses.dataclass
class PodGroupList_Items_Spec_SchedulingConstraints:
    topology: Any = None

@dataclasses.dataclass
class PodGroupList_Items_Spec_SchedulingPolicy_Gang:
    min_count: Any = None

@dataclasses.dataclass
class PodGroupList_Items_Spec_SchedulingPolicy:
    basic: Any = None
    gang: Any = None

@dataclasses.dataclass
class PodGroupList_Items_Spec_WorkloadRef:
    template_name: Any = None
    workload_name: Any = None

@dataclasses.dataclass
class PodGroupList_Items_Spec:
...
@dataclasses.dataclass
class PodGroupList_Items_Status_Conditions:
...
@dataclasses.dataclass
class PodGroupList_Items_Status_ResourceClaimStatuses:
    name: Any = None
    resource_claim_name: Any = None

@dataclasses.dataclass
class PodGroupList_Items_Status:
    conditions: Any = None
    resource_claim_statuses: Any = None

@dataclasses.dataclass
class PodGroupList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class PodGroupList_Metadata_ShardInfo:
...
PodGroupList = ubx.DataSourceBinding(
    wire_type="kubernetes_scheduling_pod_group_list",
    fields={
