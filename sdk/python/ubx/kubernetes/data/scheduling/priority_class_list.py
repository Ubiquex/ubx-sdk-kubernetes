...
class PriorityClassList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class PriorityClassList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class PriorityClassList_Items_Metadata:
...
@dataclasses.dataclass
class PriorityClassList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class PriorityClassList_Metadata:
...
PriorityClassList = ubx.DataSourceBinding(
    wire_type="kubernetes_scheduling_priority_class_list",
    fields={
