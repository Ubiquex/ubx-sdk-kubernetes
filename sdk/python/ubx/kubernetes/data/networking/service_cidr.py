...
class ServiceCidr_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ServiceCidr_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ServiceCidr_Items_Metadata:
...
@dataclasses.dataclass
class ServiceCidr_Items_Spec:
    cidrs: Any = None

@dataclasses.dataclass
class ServiceCidr_Items_Status_Conditions:
...
@dataclasses.dataclass
class ServiceCidr_Items_Status:
    conditions: Any = None

@dataclasses.dataclass
class ServiceCidr_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class ServiceCidr_Metadata_ShardInfo:
...
ServiceCidr = ubx.DataSourceBinding(
