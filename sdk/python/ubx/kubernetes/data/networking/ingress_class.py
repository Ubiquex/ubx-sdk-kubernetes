...
class IngressClass_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class IngressClass_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class IngressClass_Items_Metadata:
...
@dataclasses.dataclass
class IngressClass_Items_Spec_Parameters:
    api_group: Any = None
    kind: Any = None
    name: Any = None
    namespace: Any = None
...
@dataclasses.dataclass
class IngressClass_Items_Spec:
    controller: Any = None
    parameters: Any = None

@dataclasses.dataclass
class IngressClass_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class IngressClass_Metadata_ShardInfo:
...
IngressClass = ubx.DataSourceBinding(
