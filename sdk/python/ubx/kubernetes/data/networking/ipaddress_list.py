...
class IpaddressList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class IpaddressList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class IpaddressList_Items_Metadata:
...
@dataclasses.dataclass
class IpaddressList_Items_Spec_ParentRef:
    group: Any = None
    name: Any = None
    namespace: Any = None
    resource: Any = None
...
@dataclasses.dataclass
class IpaddressList_Items_Spec:
    parent_ref: Any = None

@dataclasses.dataclass
class IpaddressList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class IpaddressList_Metadata_ShardInfo:
...
IpaddressList = ubx.DataSourceBinding(
    wire_type="kubernetes_networking_ipaddress_list",
    fields={
