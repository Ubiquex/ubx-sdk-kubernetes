...
class Ipaddress_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class Ipaddress_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class Ipaddress_Items_Metadata:
...
@dataclasses.dataclass
class Ipaddress_Items_Spec_ParentRef:
    group: Any = None
    name: Any = None
    namespace: Any = None
    resource: Any = None
...
@dataclasses.dataclass
class Ipaddress_Items_Spec:
    parent_ref: Any = None

@dataclasses.dataclass
class Ipaddress_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class Ipaddress_Metadata_ShardInfo:
...
Ipaddress = ubx.DataSourceBinding(
