...
class NetworkPolicy_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class NetworkPolicy_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class NetworkPolicy_Items_Metadata:
...
@dataclasses.dataclass
class NetworkPolicy_Items_Spec_Egress_Ports:
    end_port: Any = None
    port: Any = None
    protocol: Any = None

@dataclasses.dataclass
class NetworkPolicy_Items_Spec_Egress_To_IpBlock:
    cidr: Any = None
    except_: Any = None

@dataclasses.dataclass
class NetworkPolicy_Items_Spec_Egress_To_NamespaceSelector_MatchExpressions:
    key: Any = None
    operator: Any = None
    values: Any = None

@dataclasses.dataclass
class NetworkPolicy_Items_Spec_Egress_To_NamespaceSelector:
    match_expressions: Any = None
    match_labels: Any = None

@dataclasses.dataclass
class NetworkPolicy_Items_Spec_Egress_To:
    ip_block: Any = None
    namespace_selector: Any = None
    pod_selector: Any = None

@dataclasses.dataclass
class NetworkPolicy_Items_Spec_Egress:
    ports: Any = None
    to: Any = None

@dataclasses.dataclass
class NetworkPolicy_Items_Spec_Ingress:
    from_: Any = None
    ports: Any = None

@dataclasses.dataclass
class NetworkPolicy_Items_Spec:
    egress: Any = None
    ingress: Any = None
    pod_selector: Any = None
...
@dataclasses.dataclass
class NetworkPolicy_Metadata_ShardInfo:
...
NetworkPolicy = ubx.DataSourceBinding(
