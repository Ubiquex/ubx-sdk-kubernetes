...
class IngressClassList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class IngressClassList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class IngressClassList_Items_Metadata:
...
@dataclasses.dataclass
class IngressClassList_Items_Spec_Parameters:
    api_group: Any = None
    kind: Any = None
    name: Any = None
    namespace: Any = None
...
@dataclasses.dataclass
class IngressClassList_Items_Spec:
    controller: Any = None
    parameters: Any = None

@dataclasses.dataclass
class IngressClassList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class IngressClassList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class IngressClassList_Metadata:
...
IngressClassList = ubx.DataSourceBinding(
    wire_type="kubernetes_networking_ingress_class_list",
    fields={
