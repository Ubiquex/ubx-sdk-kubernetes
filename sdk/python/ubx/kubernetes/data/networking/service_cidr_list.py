...
class ServiceCidrList_Items_Metadata_ManagedFields:
...
@dataclasses.dataclass
class ServiceCidrList_Items_Metadata_OwnerReferences:
    api_version: Any = None
...
@dataclasses.dataclass
class ServiceCidrList_Items_Metadata:
...
@dataclasses.dataclass
class ServiceCidrList_Items_Spec:
    cidrs: Any = None

@dataclasses.dataclass
class ServiceCidrList_Items_Status_Conditions:
...
@dataclasses.dataclass
class ServiceCidrList_Items_Status:
    conditions: Any = None

@dataclasses.dataclass
class ServiceCidrList_Items:
    api_version: Any = None
    kind: Any = None
    metadata: Any = None
    spec: Any = None
...
@dataclasses.dataclass
class ServiceCidrList_Metadata_ShardInfo:
...
@dataclasses.dataclass
class ServiceCidrList_Metadata:
...
ServiceCidrList = ubx.DataSourceBinding(
    wire_type="kubernetes_networking_service_cidr_list",
    fields={
