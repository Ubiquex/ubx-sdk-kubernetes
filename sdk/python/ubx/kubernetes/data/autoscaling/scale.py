...
class Scale_Metadata_ManagedFields:
...
@dataclasses.dataclass
class Scale_Metadata_OwnerReferences:
    api_version: Any = None
...
Scale = ubx.DataSourceBinding(
    wire_type="kubernetes_autoscaling_scale",
    fields={
    },
)
