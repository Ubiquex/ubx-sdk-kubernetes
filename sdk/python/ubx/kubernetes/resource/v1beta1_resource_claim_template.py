...
@dataclasses.dataclass
class V1beta1ResourceClaimTemplate_Metadata:
...
@dataclasses.dataclass
class V1beta1ResourceClaimTemplate_Spec_Spec_Devices:
...
@dataclasses.dataclass
class V1beta1ResourceClaimTemplate_Spec_Spec:
    # DeviceClaim defines how to request devices with a ResourceClaim.
    devices: Any = None

@dataclasses.dataclass
class V1beta1ResourceClaimTemplate_Spec:
    # ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create.
    metadata: Any = None
    # ResourceClaimSpec defines what is being requested in a ResourceClaim and how to configure it.
    spec: Any = None

_V1beta1ResourceClaimTemplate_Metadata_ManagedFieldsFields = {
...
_V1beta1ResourceClaimTemplate_Metadata_OwnerReferencesFields = {
    "api_version": ubx.FieldSpec(wire_name="api_version"),
...
_V1beta1ResourceClaimTemplate_MetadataFields = {
    ...
    "managed_fields": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta1ResourceClaimTemplate_Metadata_ManagedFieldsFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
    ...
    "owner_references": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta1ResourceClaimTemplate_Metadata_OwnerReferencesFields,
    ),
...
_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_Config_OpaqueFields = {
    "driver": ubx.FieldSpec(wire_name="driver"),
    "parameters": ubx.FieldSpec(wire_name="parameters"),
}

_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_ConfigFields = {
    "opaque": ubx.FieldSpec(
        wire_name="opaque",
        kind="object",
        fields=_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_Config_OpaqueFields,
    ),
    "requests": ubx.FieldSpec(wire_name="requests"),
}

_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_ConstraintsFields = {
    "distinct_attribute": ubx.FieldSpec(wire_name="distinct_attribute"),
    "match_attribute": ubx.FieldSpec(wire_name="match_attribute"),
    "requests": ubx.FieldSpec(wire_name="requests"),
}

_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_Requests_CapacityFields = {
    "requests": ubx.FieldSpec(wire_name="requests"),
}

_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_Requests_DerivedAttributesFields = {
    "expression": ubx.FieldSpec(wire_name="expression"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_Requests_FirstAvailable_Selectors_CelFields = {
    "expression": ubx.FieldSpec(wire_name="expression"),
}

_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_Requests_FirstAvailable_SelectorsFields = {
    "cel": ubx.FieldSpec(
        wire_name="cel",
        kind="object",
        fields=_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_Requests_FirstAvailable_Selectors_CelFields,
    ),
}

_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_Requests_FirstAvailable_TolerationsFields = {
...
_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_Requests_FirstAvailableFields = {
    "allocation_mode": ubx.FieldSpec(wire_name="allocation_mode"),
    "capacity": ubx.FieldSpec(
        wire_name="capacity",
        kind="object",
        fields=_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_Requests_CapacityFields,
    ),
    "count": ubx.FieldSpec(wire_name="count"),
    "derived_attributes": ubx.FieldSpec(
        wire_name="derived_attributes",
        kind="list",
        fields=_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_Requests_DerivedAttributesFields,
    ),
    ...
    "selectors": ubx.FieldSpec(
        wire_name="selectors",
        kind="list",
        fields=_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_Requests_FirstAvailable_SelectorsFields,
    ),
    "tolerations": ubx.FieldSpec(
        wire_name="tolerations",
        kind="list",
        fields=_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_Requests_FirstAvailable_TolerationsFields,
    ),
}

_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_RequestsFields = {
    ...
    "first_available": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_Requests_FirstAvailableFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
    "selectors": ubx.FieldSpec(
        wire_name="selectors",
...
_V1beta1ResourceClaimTemplate_Spec_Spec_DevicesFields = {
    "config": ubx.FieldSpec(
        wire_name="config",
        kind="list",
        fields=_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_ConfigFields,
    ),
    "constraints": ubx.FieldSpec(
        wire_name="constraints",
        kind="list",
        fields=_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_ConstraintsFields,
    ),
    "requests": ubx.FieldSpec(
        wire_name="requests",
        kind="list",
        fields=_V1beta1ResourceClaimTemplate_Spec_Spec_Devices_RequestsFields,
    ),
}

_V1beta1ResourceClaimTemplate_Spec_SpecFields = {
    "devices": ubx.FieldSpec(
        wire_name="devices",
        kind="object",
        fields=_V1beta1ResourceClaimTemplate_Spec_Spec_DevicesFields,
    ),
}

_V1beta1ResourceClaimTemplate_SpecFields = {
    "metadata": ubx.FieldSpec(
        wire_name="metadata",
        kind="object",
        fields=_V1beta1ResourceClaimTemplate_MetadataFields,
    ),
    "spec": ubx.FieldSpec(
        wire_name="spec",
        kind="object",
        fields=_V1beta1ResourceClaimTemplate_Spec_SpecFields,
    ),
}

@dataclasses.dataclass
class V1beta1ResourceClaimTemplateConfig:
...
@dataclasses.dataclass
class V1beta1ResourceClaimTemplateAttrs:
    # APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    api_version: Any = None
    # Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: Any = None
...
V1beta1ResourceClaimTemplate = ubx.ResourceBinding(
    wire_type="kubernetes_resource_v1beta1_resource_claim_template",
    fields={
        "api_version": ubx.FieldSpec(wire_name="api_version"),
        "kind": ubx.FieldSpec(wire_name="kind"),
        "metadata": ubx.FieldSpec(
        ...
        "spec": ubx.FieldSpec(
            wire_name="spec",
            kind="object",
            fields=_V1beta1ResourceClaimTemplate_SpecFields,
        ),
        "namespace": ubx.FieldSpec(wire_name="namespace"),
        "name": ubx.FieldSpec(wire_name="name"),
    },
