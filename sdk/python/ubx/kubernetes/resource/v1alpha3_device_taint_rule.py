...
class V1alpha3DeviceTaintRule_Metadata_ManagedFields:
...
@dataclasses.dataclass
class V1alpha3DeviceTaintRule_Metadata_OwnerReferences:
...
@dataclasses.dataclass
class V1alpha3DeviceTaintRule_Metadata:
...
@dataclasses.dataclass
class V1alpha3DeviceTaintRule_Spec_DeviceSelector:
...
@dataclasses.dataclass
class V1alpha3DeviceTaintRule_Spec_Taint:
...
@dataclasses.dataclass
class V1alpha3DeviceTaintRule_Spec:
...
@dataclasses.dataclass
class V1alpha3DeviceTaintRule_Status_Conditions:
...
@dataclasses.dataclass
class V1alpha3DeviceTaintRule_Status:
...
_V1alpha3DeviceTaintRule_Metadata_ManagedFieldsFields = {
...
_V1alpha3DeviceTaintRule_Metadata_OwnerReferencesFields = {
    "api_version": ubx.FieldSpec(wire_name="api_version"),
...
_V1alpha3DeviceTaintRule_MetadataFields = {
    ...
    "managed_fields": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1alpha3DeviceTaintRule_Metadata_ManagedFieldsFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
    ...
    "owner_references": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1alpha3DeviceTaintRule_Metadata_OwnerReferencesFields,
    ),
...
_V1alpha3DeviceTaintRule_SpecFields = {
    "device_selector": ubx.FieldSpec(
        wire_name="device_selector",
        kind="object",
        fields=_V1alpha3DeviceTaintRule_Spec_DeviceSelectorFields,
    ),
    "taint": ubx.FieldSpec(
        wire_name="taint",
        kind="object",
        fields=_V1alpha3DeviceTaintRule_Spec_TaintFields,
    ),
}

_V1alpha3DeviceTaintRule_Status_ConditionsFields = {
...
_V1alpha3DeviceTaintRule_StatusFields = {
    "conditions": ubx.FieldSpec(
        wire_name="conditions",
        kind="list",
        fields=_V1alpha3DeviceTaintRule_Status_ConditionsFields,
    ),
}

@dataclasses.dataclass
class V1alpha3DeviceTaintRuleConfig:
...
@dataclasses.dataclass
class V1alpha3DeviceTaintRuleAttrs:
    # APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    api_version: Any = None
    # Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: Any = None
...
V1alpha3DeviceTaintRule = ubx.ResourceBinding(
    wire_type="kubernetes_resource_v1alpha3_device_taint_rule",
    fields={
        "api_version": ubx.FieldSpec(wire_name="api_version"),
        "kind": ubx.FieldSpec(wire_name="kind"),
        "metadata": ubx.FieldSpec(
            wire_name="metadata",
            kind="object",
            fields=_V1alpha3DeviceTaintRule_MetadataFields,
        ),
        "spec": ubx.FieldSpec(
            wire_name="spec",
            kind="object",
            fields=_V1alpha3DeviceTaintRule_SpecFields,
        ),
        "status": ubx.FieldSpec(
            wire_name="status",
            kind="object",
            fields=_V1alpha3DeviceTaintRule_StatusFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
    },
)
