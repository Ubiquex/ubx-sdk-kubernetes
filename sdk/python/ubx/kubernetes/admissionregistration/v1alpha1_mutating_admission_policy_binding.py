...
class V1alpha1MutatingAdmissionPolicyBinding_Metadata_ManagedFields:
...
@dataclasses.dataclass
class V1alpha1MutatingAdmissionPolicyBinding_Metadata_OwnerReferences:
...
@dataclasses.dataclass
class V1alpha1MutatingAdmissionPolicyBinding_Metadata:
...
@dataclasses.dataclass
class V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_ExcludeResourceRules:
...
@dataclasses.dataclass
class V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelector_MatchExpressions:
...
@dataclasses.dataclass
class V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelector:
...
@dataclasses.dataclass
class V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources:
...
@dataclasses.dataclass
class V1alpha1MutatingAdmissionPolicyBinding_Spec_ParamRef:
...
@dataclasses.dataclass
class V1alpha1MutatingAdmissionPolicyBinding_Spec:
...
_V1alpha1MutatingAdmissionPolicyBinding_Metadata_ManagedFieldsFields = {
...
_V1alpha1MutatingAdmissionPolicyBinding_Metadata_OwnerReferencesFields = {
    "api_version": ubx.FieldSpec(wire_name="api_version"),
...
_V1alpha1MutatingAdmissionPolicyBinding_MetadataFields = {
    ...
    "managed_fields": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1alpha1MutatingAdmissionPolicyBinding_Metadata_ManagedFieldsFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
    ...
    "owner_references": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1alpha1MutatingAdmissionPolicyBinding_Metadata_OwnerReferencesFields,
    ),
...
_V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_ExcludeResourceRulesFields = {
...
_V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelector_MatchExpressionsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "operator": ubx.FieldSpec(wire_name="operator"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelectorFields = {
    "match_expressions": ubx.FieldSpec(
        wire_name="match_expressions",
        kind="list",
        fields=_V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelector_MatchExpressionsFields,
    ),
    "match_labels": ubx.FieldSpec(wire_name="match_labels"),
}

_V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResourcesFields = {
    "exclude_resource_rules": ubx.FieldSpec(
        wire_name="exclude_resource_rules",
        kind="list",
        fields=_V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_ExcludeResourceRulesFields,
    ),
    "match_policy": ubx.FieldSpec(wire_name="match_policy"),
    "namespace_selector": ubx.FieldSpec(
        wire_name="namespace_selector",
        kind="object",
        fields=_V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelectorFields,
    ),
...
_V1alpha1MutatingAdmissionPolicyBinding_Spec_ParamRefFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "namespace": ubx.FieldSpec(wire_name="namespace"),
...
_V1alpha1MutatingAdmissionPolicyBinding_SpecFields = {
    "match_resources": ubx.FieldSpec(
        wire_name="match_resources",
        kind="object",
        fields=_V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResourcesFields,
    ),
    "param_ref": ubx.FieldSpec(
        wire_name="param_ref",
        kind="object",
        fields=_V1alpha1MutatingAdmissionPolicyBinding_Spec_ParamRefFields,
    ),
    "policy_name": ubx.FieldSpec(wire_name="policy_name"),
}

@dataclasses.dataclass
class V1alpha1MutatingAdmissionPolicyBindingConfig:
...
@dataclasses.dataclass
class V1alpha1MutatingAdmissionPolicyBindingAttrs:
    # APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    api_version: Any = None
    # Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: Any = None
...
V1alpha1MutatingAdmissionPolicyBinding = ubx.ResourceBinding(
    wire_type="kubernetes_admissionregistration_v1alpha1_mutating_admission_policy_binding",
    fields={
        "api_version": ubx.FieldSpec(wire_name="api_version"),
        "kind": ubx.FieldSpec(wire_name="kind"),
        "metadata": ubx.FieldSpec(
            wire_name="metadata",
            kind="object",
            fields=_V1alpha1MutatingAdmissionPolicyBinding_MetadataFields,
        ),
        "spec": ubx.FieldSpec(
            wire_name="spec",
            kind="object",
            fields=_V1alpha1MutatingAdmissionPolicyBinding_SpecFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
    },
)
