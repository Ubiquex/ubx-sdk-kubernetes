...
class V1beta1StorageVersionMigration_Metadata_ManagedFields:
...
@dataclasses.dataclass
class V1beta1StorageVersionMigration_Metadata_OwnerReferences:
...
@dataclasses.dataclass
class V1beta1StorageVersionMigration_Metadata:
...
@dataclasses.dataclass
class V1beta1StorageVersionMigration_Spec_Resource:
...
@dataclasses.dataclass
class V1beta1StorageVersionMigration_Spec:
    # GroupResource specifies a Group and a Resource, but does not force a version. This is useful for identifying concepts during lookup stages without having partially valid types
    resource: Any = None

@dataclasses.dataclass
class V1beta1StorageVersionMigration_Status_Conditions:
...
@dataclasses.dataclass
class V1beta1StorageVersionMigration_Status:
    # The latest available observations of the migration's current state.
    conditions: Any = None
    # ResourceVersion to compare with the GC cache for performing the migration. This is the current resource version of given group, version and resource when kube-controller-manager first observes this StorageVersionMigration resource.
    resource_version: Any = None

_V1beta1StorageVersionMigration_Metadata_ManagedFieldsFields = {
...
_V1beta1StorageVersionMigration_Metadata_OwnerReferencesFields = {
    "api_version": ubx.FieldSpec(wire_name="api_version"),
...
_V1beta1StorageVersionMigration_MetadataFields = {
    ...
    "managed_fields": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta1StorageVersionMigration_Metadata_ManagedFieldsFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
    ...
    "owner_references": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta1StorageVersionMigration_Metadata_OwnerReferencesFields,
    ),
...
_V1beta1StorageVersionMigration_Spec_ResourceFields = {
    "group": ubx.FieldSpec(wire_name="group"),
    "resource": ubx.FieldSpec(wire_name="resource"),
}

_V1beta1StorageVersionMigration_SpecFields = {
    "resource": ubx.FieldSpec(
        wire_name="resource",
        kind="object",
        fields=_V1beta1StorageVersionMigration_Spec_ResourceFields,
    ),
}

_V1beta1StorageVersionMigration_Status_ConditionsFields = {
...
_V1beta1StorageVersionMigration_StatusFields = {
    "conditions": ubx.FieldSpec(
        wire_name="conditions",
        kind="list",
        fields=_V1beta1StorageVersionMigration_Status_ConditionsFields,
    ),
    "resource_version": ubx.FieldSpec(wire_name="resource_version"),
}

@dataclasses.dataclass
class V1beta1StorageVersionMigrationConfig:
...
@dataclasses.dataclass
class V1beta1StorageVersionMigrationAttrs:
    # APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    api_version: Any = None
    # Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: Any = None
...
V1beta1StorageVersionMigration = ubx.ResourceBinding(
    wire_type="kubernetes_storagemigration_v1beta1_storage_version_migration",
    fields={
        "api_version": ubx.FieldSpec(wire_name="api_version"),
        "kind": ubx.FieldSpec(wire_name="kind"),
        "metadata": ubx.FieldSpec(
            wire_name="metadata",
            kind="object",
            fields=_V1beta1StorageVersionMigration_MetadataFields,
        ),
        "spec": ubx.FieldSpec(
            wire_name="spec",
            kind="object",
            fields=_V1beta1StorageVersionMigration_SpecFields,
        ),
        "status": ubx.FieldSpec(
            wire_name="status",
            kind="object",
            fields=_V1beta1StorageVersionMigration_StatusFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
    },
)
