...
@dataclasses.dataclass
class V1beta1ClusterTrustBundle_Metadata:
...
@dataclasses.dataclass
class V1beta1ClusterTrustBundle_Spec:
...
_V1beta1ClusterTrustBundle_Metadata_ManagedFieldsFields = {
...
_V1beta1ClusterTrustBundle_Metadata_OwnerReferencesFields = {
    "api_version": ubx.FieldSpec(wire_name="api_version"),
...
_V1beta1ClusterTrustBundle_MetadataFields = {
    ...
    "managed_fields": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta1ClusterTrustBundle_Metadata_ManagedFieldsFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
    ...
    "owner_references": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta1ClusterTrustBundle_Metadata_OwnerReferencesFields,
    ),
...
@dataclasses.dataclass
class V1beta1ClusterTrustBundleAttrs:
    # APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    api_version: Any = None
    # Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: Any = None
...
V1beta1ClusterTrustBundle = ubx.ResourceBinding(
    wire_type="kubernetes_certificates_v1beta1_cluster_trust_bundle",
    fields={
        "api_version": ubx.FieldSpec(wire_name="api_version"),
        "kind": ubx.FieldSpec(wire_name="kind"),
        "metadata": ubx.FieldSpec(
            wire_name="metadata",
            kind="object",
            fields=_V1beta1ClusterTrustBundle_MetadataFields,
        ),
        "spec": ubx.FieldSpec(
            wire_name="spec",
            kind="object",
            fields=_V1beta1ClusterTrustBundle_SpecFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
    },
)
