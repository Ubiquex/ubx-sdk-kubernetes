...
type V1beta2DeviceTaintRule_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type V1beta2DeviceTaintRule_Metadata_OwnerReferences struct {
	ApiVersion any
...
type V1beta2DeviceTaintRule_Metadata struct {
...
type V1beta2DeviceTaintRule_Spec_DeviceSelector struct {
...
type V1beta2DeviceTaintRule_Spec_Taint struct {
...
type V1beta2DeviceTaintRule_Spec struct {
...
type V1beta2DeviceTaintRule_Status_Conditions struct {
...
type V1beta2DeviceTaintRule_Status struct {
...
var V1beta2DeviceTaintRule_Metadata_ManagedFieldsFields = ubx.FieldMap{
...
var V1beta2DeviceTaintRule_Metadata_OwnerReferencesFields = ubx.FieldMap{
		"ApiVersion": ubx.FieldSpec{WireName: "api_version"},
...
var V1beta2DeviceTaintRule_MetadataFields = ubx.FieldMap{
...
var V1beta2DeviceTaintRule_Spec_DeviceSelectorFields = ubx.FieldMap{
		"Device": ubx.FieldSpec{WireName: "device"},
		"Driver": ubx.FieldSpec{WireName: "driver"},
		"Pool": ubx.FieldSpec{WireName: "pool"},
	}

var V1beta2DeviceTaintRule_Spec_TaintFields = ubx.FieldMap{
...
var V1beta2DeviceTaintRule_SpecFields = ubx.FieldMap{
...
var V1beta2DeviceTaintRule_Status_ConditionsFields = ubx.FieldMap{
...
var V1beta2DeviceTaintRule_StatusFields = ubx.FieldMap{
...
type V1beta2DeviceTaintRuleConfig struct {
...
type V1beta2DeviceTaintRuleAttrs struct {
	// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
	ApiVersion any
	// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
	Kind any
...
var V1beta2DeviceTaintRule = ubx.ResourceBinding{
