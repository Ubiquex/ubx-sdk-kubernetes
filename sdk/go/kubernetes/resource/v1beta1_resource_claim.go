...
type V1beta1ResourceClaim_Metadata struct {
...
type V1beta1ResourceClaim_Spec_Devices struct {
...
type V1beta1ResourceClaim_Spec struct {
...
type V1beta1ResourceClaim_Status_Allocation_Devices struct {
...
type V1beta1ResourceClaim_Status_Allocation_NodeSelector struct {
	// Required. A list of node selector terms. The terms are ORed.
	NodeSelectorTerms any
}

type V1beta1ResourceClaim_Status_Allocation struct {
	// Time is a wrapper around time.Time which supports correct marshaling to YAML and JSON. Wrappers are provided for many of the factory methods that the time package offers.
...
type V1beta1ResourceClaim_Status struct {
...
type V1beta1ResourceClaimAttrs struct {
	// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
	ApiVersion any
	// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
	Kind any
...
var V1beta1ResourceClaim = ubx.ResourceBinding{
