...
type StorageVersionMigration_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type StorageVersionMigration_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type StorageVersionMigration_Items_Metadata struct {
	Annotations                any
...
type StorageVersionMigration_Items_Spec_Resource struct {
	Group    any
	Resource any
}

type StorageVersionMigration_Items_Spec struct {
	Resource any
}

type StorageVersionMigration_Items_Status_Conditions struct {
...
type StorageVersionMigration_Items_Status struct {
	Conditions      any
	ResourceVersion any
}

type StorageVersionMigration_Items struct {
	ApiVersion any
	Kind       any
	Metadata   any
	Spec       any
...
type StorageVersionMigration_Metadata_ShardInfo struct {
