...
type EndpointSliceList_Items_Endpoints_Hints_ForNodes struct {
	Name any
}

type EndpointSliceList_Items_Endpoints_Hints struct {
	ForNodes any
	ForZones any
}
...
type EndpointSliceList_Metadata struct {
...
type EndpointSliceListConfig struct {
}

type EndpointSliceListAttrs struct {
