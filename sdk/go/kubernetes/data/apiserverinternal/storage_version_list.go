...
type StorageVersionList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type StorageVersionList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type StorageVersionList_Items_Metadata struct {
	Annotations any
...
type StorageVersionList_Items_Status_Conditions struct {
...
type StorageVersionList_Items_Status_StorageVersions struct {
	ApiServerId any
...
type StorageVersionList_Items_Status struct {
	CommonEncodingVersion any
	Conditions any
	StorageVersions any
}

type StorageVersionList_Items struct {
	ApiVersion any
	Kind any
	Metadata any
	Spec any
...
type StorageVersionList_Metadata_ShardInfo struct {
...
type StorageVersionList_Metadata struct {
...
type StorageVersionListConfig struct {
...
type StorageVersionListAttrs struct {
	AllowWatchBookmarks any
...
var StorageVersionList = ubx.DataSourceBinding{
