...
type StorageVersion_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type StorageVersion_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type StorageVersion_Items_Metadata struct {
	Annotations                any
...
type StorageVersion_Items_Status_Conditions struct {
...
type StorageVersion_Items_Status_StorageVersions struct {
	ApiServerId       any
...
type StorageVersion_Items_Status struct {
	CommonEncodingVersion any
	Conditions            any
	StorageVersions       any
}

type StorageVersion_Items struct {
	ApiVersion any
	Kind       any
	Metadata   any
	Spec       any
...
type StorageVersion_Metadata_ShardInfo struct {
