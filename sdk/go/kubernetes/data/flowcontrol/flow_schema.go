...
type FlowSchema_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type FlowSchema_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type FlowSchema_Items_Metadata struct {
	Annotations                any
...
type FlowSchema_Items_Spec_DistinguisherMethod struct {
	Type any
}

type FlowSchema_Items_Spec_PriorityLevelConfiguration struct {
	Name any
}

type FlowSchema_Items_Spec_Rules_NonResourceRules struct {
	NonResourceUrls any
	Verbs           any
}

type FlowSchema_Items_Spec_Rules_ResourceRules struct {
	ApiGroups    any
	ClusterScope any
	Namespaces   any
	Resources    any
...
type FlowSchema_Items_Spec_Rules_Subjects_ServiceAccount struct {
	Name      any
	Namespace any
}

type FlowSchema_Items_Spec_Rules_Subjects struct {
	Group          any
	Kind           any
	ServiceAccount any
	User           any
...
type FlowSchema_Items_Spec_Rules struct {
	NonResourceRules any
	ResourceRules    any
	Subjects         any
}

type FlowSchema_Items_Spec struct {
...
type FlowSchema_Items_Status_Conditions struct {
...
type FlowSchema_Items_Status struct {
	Conditions any
}

type FlowSchema_Items struct {
	ApiVersion any
	Kind       any
	Metadata   any
	Spec       any
...
type FlowSchema_Metadata_ShardInfo struct {
