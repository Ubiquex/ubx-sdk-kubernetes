...
type Apiservice_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type Apiservice_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type Apiservice_Items_Metadata struct {
	Annotations                any
...
type Apiservice_Items_Spec_Service struct {
	Name      any
	Namespace any
	Port      any
}

type Apiservice_Items_Spec struct {
	CaBundle              any
	Group                 any
...
type Apiservice_Items_Status_Conditions struct {
...
type Apiservice_Items_Status struct {
	Conditions any
}

type Apiservice_Items struct {
	ApiVersion any
	Kind       any
	Metadata   any
	Spec       any
...
type Apiservice_Metadata_ShardInfo struct {
