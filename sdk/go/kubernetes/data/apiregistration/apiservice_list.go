...
type ApiserviceList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type ApiserviceList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type ApiserviceList_Items_Metadata struct {
	Annotations any
...
type ApiserviceList_Items_Spec_Service struct {
	Name any
	Namespace any
	Port any
}

type ApiserviceList_Items_Spec struct {
	CaBundle any
	Group any
...
type ApiserviceList_Items_Status_Conditions struct {
...
type ApiserviceList_Items_Status struct {
	Conditions any
}

type ApiserviceList_Items struct {
	ApiVersion any
	Kind any
	Metadata any
	Spec any
...
type ApiserviceList_Metadata_ShardInfo struct {
...
type ApiserviceList_Metadata struct {
...
type ApiserviceListConfig struct {
...
type ApiserviceListAttrs struct {
	AllowWatchBookmarks any
...
var ApiserviceList = ubx.DataSourceBinding{
