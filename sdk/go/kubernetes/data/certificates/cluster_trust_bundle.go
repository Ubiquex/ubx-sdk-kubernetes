...
type ClusterTrustBundle_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type ClusterTrustBundle_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type ClusterTrustBundle_Items_Metadata struct {
	Annotations                any
...
type ClusterTrustBundle_Items_Spec struct {
	SignerName  any
	TrustBundle any
}

type ClusterTrustBundle_Items struct {
	ApiVersion any
	Kind       any
	Metadata   any
	Spec       any
...
type ClusterTrustBundle_Metadata_ShardInfo struct {
...
var ClusterTrustBundle = ubx.DataSourceBinding{
