...
type CertificateSigningRequestList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type CertificateSigningRequestList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type CertificateSigningRequestList_Items_Metadata struct {
	Annotations any
...
type CertificateSigningRequestList_Items_Spec struct {
...
type CertificateSigningRequestList_Items_Status_Conditions struct {
...
type CertificateSigningRequestList_Items_Status struct {
	Certificate any
	Conditions any
}

type CertificateSigningRequestList_Items struct {
	ApiVersion any
	Kind any
	Metadata any
	Spec any
...
type CertificateSigningRequestList_Metadata_ShardInfo struct {
...
type CertificateSigningRequestList_Metadata struct {
...
type CertificateSigningRequestListConfig struct {
...
type CertificateSigningRequestListAttrs struct {
	AllowWatchBookmarks any
...
var CertificateSigningRequestList = ubx.DataSourceBinding{
