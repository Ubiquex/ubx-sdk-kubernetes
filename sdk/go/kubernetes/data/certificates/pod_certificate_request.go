...
type PodCertificateRequest_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type PodCertificateRequest_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type PodCertificateRequest_Items_Metadata struct {
	Annotations                any
...
type PodCertificateRequest_Items_Spec struct {
...
type PodCertificateRequest_Items_Status_Conditions struct {
...
type PodCertificateRequest_Items_Status struct {
	BeginRefreshAt   any
...
type PodCertificateRequest_Items struct {
	ApiVersion any
	Kind       any
	Metadata   any
	Spec       any
...
type PodCertificateRequest_Metadata_ShardInfo struct {
