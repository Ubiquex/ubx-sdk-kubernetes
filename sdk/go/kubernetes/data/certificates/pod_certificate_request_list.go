...
type PodCertificateRequestList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type PodCertificateRequestList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type PodCertificateRequestList_Items_Metadata struct {
	Annotations any
...
type PodCertificateRequestList_Items_Spec struct {
...
type PodCertificateRequestList_Items_Status_Conditions struct {
...
type PodCertificateRequestList_Items_Status struct {
	BeginRefreshAt any
...
type PodCertificateRequestList_Items struct {
	ApiVersion any
	Kind any
	Metadata any
	Spec any
...
type PodCertificateRequestList_Metadata_ShardInfo struct {
...
type PodCertificateRequestList_Metadata struct {
...
type PodCertificateRequestListConfig struct {
...
type PodCertificateRequestListAttrs struct {
	AllowWatchBookmarks any
...
var PodCertificateRequestList = ubx.DataSourceBinding{
