...
type ClusterTrustBundleList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type ClusterTrustBundleList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type ClusterTrustBundleList_Items_Metadata struct {
	Annotations any
...
type ClusterTrustBundleList_Items_Spec struct {
	SignerName any
	TrustBundle any
}

type ClusterTrustBundleList_Items struct {
	ApiVersion any
	Kind any
	Metadata any
	Spec any
...
type ClusterTrustBundleList_Metadata_ShardInfo struct {
...
type ClusterTrustBundleList_Metadata struct {
...
type ClusterTrustBundleListConfig struct {
...
type ClusterTrustBundleListAttrs struct {
	AllowWatchBookmarks any
...
var ClusterTrustBundleList = ubx.DataSourceBinding{
