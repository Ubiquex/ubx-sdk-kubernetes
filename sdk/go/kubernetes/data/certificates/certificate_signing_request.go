...
type CertificateSigningRequest_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type CertificateSigningRequest_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type CertificateSigningRequest_Items_Metadata struct {
	Annotations                any
...
type CertificateSigningRequest_Items_Spec struct {
...
type CertificateSigningRequest_Items_Status_Conditions struct {
...
type CertificateSigningRequest_Items_Status struct {
	Certificate any
	Conditions  any
}

type CertificateSigningRequest_Items struct {
	ApiVersion any
	Kind       any
	Metadata   any
	Spec       any
...
type CertificateSigningRequest_Metadata_ShardInfo struct {
