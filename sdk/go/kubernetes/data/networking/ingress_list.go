...
type IngressList_Items_Spec_DefaultBackend_Service struct {
	Name any
	Port any
}
...
type IngressList_Items_Spec_Rules_Http struct {
	Paths any
}

type IngressList_Items_Spec_Rules struct {
	Host any
	Http any
}
...
type IngressList_Items_Status struct {
	LoadBalancer any
}
...
type IngressList_Metadata struct {
...
type IngressListConfig struct {
}

type IngressListAttrs struct {
