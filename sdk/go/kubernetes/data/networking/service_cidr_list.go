...
type ServiceCidrList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type ServiceCidrList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type ServiceCidrList_Items_Metadata struct {
	Annotations any
...
type ServiceCidrList_Items_Spec struct {
	Cidrs any
}

type ServiceCidrList_Items_Status_Conditions struct {
...
type ServiceCidrList_Items_Status struct {
	Conditions any
}

type ServiceCidrList_Items struct {
	ApiVersion any
	Kind any
	Metadata any
	Spec any
...
type ServiceCidrList_Metadata_ShardInfo struct {
...
type ServiceCidrList_Metadata struct {
...
type ServiceCidrListConfig struct {
...
type ServiceCidrListAttrs struct {
	AllowWatchBookmarks any
...
var ServiceCidrList = ubx.DataSourceBinding{
