...
type IngressClassList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type IngressClassList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type IngressClassList_Items_Metadata struct {
	Annotations any
...
type IngressClassList_Items_Spec_Parameters struct {
	ApiGroup any
	Kind any
	Name any
	Namespace any
...
type IngressClassList_Items_Spec struct {
	Controller any
	Parameters any
}

type IngressClassList_Items struct {
	ApiVersion any
	Kind any
	Metadata any
	Spec any
...
type IngressClassList_Metadata_ShardInfo struct {
...
type IngressClassList_Metadata struct {
...
type IngressClassListConfig struct {
...
type IngressClassListAttrs struct {
	AllowWatchBookmarks any
...
var IngressClassList = ubx.DataSourceBinding{
