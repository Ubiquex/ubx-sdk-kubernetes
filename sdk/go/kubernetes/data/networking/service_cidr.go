...
type ServiceCidr_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type ServiceCidr_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type ServiceCidr_Items_Metadata struct {
	Annotations                any
...
type ServiceCidr_Items_Spec struct {
	Cidrs any
}

type ServiceCidr_Items_Status_Conditions struct {
...
type ServiceCidr_Items_Status struct {
	Conditions any
}

type ServiceCidr_Items struct {
	ApiVersion any
	Kind       any
	Metadata   any
	Spec       any
...
type ServiceCidr_Metadata_ShardInfo struct {
