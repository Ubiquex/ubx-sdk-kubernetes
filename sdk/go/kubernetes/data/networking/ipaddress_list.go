...
type IpaddressList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type IpaddressList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type IpaddressList_Items_Metadata struct {
	Annotations any
...
type IpaddressList_Items_Spec_ParentRef struct {
	Group any
	Name any
	Namespace any
	Resource any
...
type IpaddressList_Items_Spec struct {
	ParentRef any
}

type IpaddressList_Items struct {
	ApiVersion any
	Kind any
	Metadata any
	Spec any
...
type IpaddressList_Metadata_ShardInfo struct {
...
type IpaddressList_Metadata struct {
...
type IpaddressListConfig struct {
...
type IpaddressListAttrs struct {
	AllowWatchBookmarks any
...
var IpaddressList = ubx.DataSourceBinding{
