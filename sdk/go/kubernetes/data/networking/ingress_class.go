...
type IngressClass_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type IngressClass_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type IngressClass_Items_Metadata struct {
	Annotations                any
...
type IngressClass_Items_Spec_Parameters struct {
	ApiGroup  any
	Kind      any
	Name      any
	Namespace any
...
type IngressClass_Items_Spec struct {
	Controller any
	Parameters any
}

type IngressClass_Items struct {
	ApiVersion any
	Kind       any
	Metadata   any
	Spec       any
...
type IngressClass_Metadata_ShardInfo struct {
...
var IngressClass = ubx.DataSourceBinding{
