...
type Ipaddress_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type Ipaddress_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type Ipaddress_Items_Metadata struct {
	Annotations                any
...
type Ipaddress_Items_Spec_ParentRef struct {
	Group     any
	Name      any
	Namespace any
	Resource  any
...
type Ipaddress_Items_Spec struct {
	ParentRef any
}

type Ipaddress_Items struct {
	ApiVersion any
	Kind       any
	Metadata   any
	Spec       any
...
type Ipaddress_Metadata_ShardInfo struct {
...
var Ipaddress = ubx.DataSourceBinding{
