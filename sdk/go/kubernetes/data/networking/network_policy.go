...
type NetworkPolicy_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type NetworkPolicy_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type NetworkPolicy_Items_Metadata struct {
	Annotations                any
...
type NetworkPolicy_Items_Spec_Egress_Ports struct {
	EndPort  any
	Port     any
	Protocol any
}

type NetworkPolicy_Items_Spec_Egress_To_IpBlock struct {
	Cidr   any
	Except any
}

type NetworkPolicy_Items_Spec_Egress_To_NamespaceSelector_MatchExpressions struct {
	Key      any
	Operator any
	Values   any
}

type NetworkPolicy_Items_Spec_Egress_To_NamespaceSelector struct {
	MatchExpressions any
	MatchLabels      any
}

type NetworkPolicy_Items_Spec_Egress_To struct {
	IpBlock           any
	NamespaceSelector any
	PodSelector       any
}

type NetworkPolicy_Items_Spec_Egress struct {
	Ports any
	To    any
}

type NetworkPolicy_Items_Spec_Ingress struct {
	From  any
	Ports any
}

type NetworkPolicy_Items_Spec struct {
	Egress      any
	Ingress     any
	PodSelector any
	PolicyTypes any
...
type NetworkPolicy_Items struct {
	ApiVersion any
	Kind       any
	Metadata   any
	Spec       any
...
type NetworkPolicy_Metadata_ShardInfo struct {
...
var NetworkPolicy = ubx.DataSourceBinding{
