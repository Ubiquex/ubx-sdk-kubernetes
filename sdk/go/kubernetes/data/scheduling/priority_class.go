...
type PriorityClass_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type PriorityClass_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type PriorityClass_Items_Metadata struct {
	Annotations                any
...
type PriorityClass_Items struct {
	ApiVersion       any
	Description      any
	GlobalDefault    any
	Kind             any
...
type PriorityClass_Metadata_ShardInfo struct {
...
var PriorityClass = ubx.DataSourceBinding{
