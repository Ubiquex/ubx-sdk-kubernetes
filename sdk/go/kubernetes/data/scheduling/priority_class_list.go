...
type PriorityClassList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type PriorityClassList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type PriorityClassList_Items_Metadata struct {
	Annotations any
...
type PriorityClassList_Items struct {
	ApiVersion any
	Description any
	GlobalDefault any
	Kind any
...
type PriorityClassList_Metadata_ShardInfo struct {
...
type PriorityClassList_Metadata struct {
...
type PriorityClassListConfig struct {
...
type PriorityClassListAttrs struct {
	AllowWatchBookmarks any
...
var PriorityClassList = ubx.DataSourceBinding{
