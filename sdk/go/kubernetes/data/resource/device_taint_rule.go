...
type DeviceTaintRule_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type DeviceTaintRule_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type DeviceTaintRule_Items_Metadata struct {
	Annotations                any
...
type DeviceTaintRule_Items_Spec_DeviceSelector struct {
	Device any
	Driver any
	Pool   any
}

type DeviceTaintRule_Items_Spec_Taint struct {
	Effect    any
	Key       any
	TimeAdded any
	Value     any
...
type DeviceTaintRule_Items_Spec struct {
	DeviceSelector any
	Taint          any
}

type DeviceTaintRule_Items_Status_Conditions struct {
...
type DeviceTaintRule_Items_Status struct {
	Conditions any
}

type DeviceTaintRule_Items struct {
	ApiVersion any
	Kind       any
	Metadata   any
	Spec       any
...
type DeviceTaintRule_Metadata_ShardInfo struct {
