...
type DeviceTaintRuleList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type DeviceTaintRuleList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type DeviceTaintRuleList_Items_Metadata struct {
	Annotations any
...
type DeviceTaintRuleList_Items_Spec_DeviceSelector struct {
	Device any
	Driver any
	Pool any
}

type DeviceTaintRuleList_Items_Spec_Taint struct {
	Effect any
	Key any
	TimeAdded any
	Value any
...
type DeviceTaintRuleList_Items_Spec struct {
	DeviceSelector any
	Taint any
}

type DeviceTaintRuleList_Items_Status_Conditions struct {
...
type DeviceTaintRuleList_Items_Status struct {
	Conditions any
}

type DeviceTaintRuleList_Items struct {
	ApiVersion any
	Kind any
	Metadata any
	Spec any
...
type DeviceTaintRuleList_Metadata_ShardInfo struct {
...
type DeviceTaintRuleList_Metadata struct {
...
type DeviceTaintRuleListConfig struct {
...
type DeviceTaintRuleListAttrs struct {
	AllowWatchBookmarks any
...
var DeviceTaintRuleList = ubx.DataSourceBinding{
