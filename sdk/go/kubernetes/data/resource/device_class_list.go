...
type DeviceClassList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type DeviceClassList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type DeviceClassList_Items_Metadata struct {
	Annotations any
...
type DeviceClassList_Items_Spec_Config_Opaque struct {
	Driver any
	Parameters any
}

type DeviceClassList_Items_Spec_Config struct {
	Opaque any
}

type DeviceClassList_Items_Spec_Selectors_Cel struct {
	Expression any
}

type DeviceClassList_Items_Spec_Selectors struct {
	Cel any
}

type DeviceClassList_Items_Spec struct {
	Config any
	ExtendedResourceName any
	Selectors any
}

type DeviceClassList_Items struct {
	ApiVersion any
	Kind any
	Metadata any
	Spec any
...
type DeviceClassList_Metadata_ShardInfo struct {
...
type DeviceClassList_Metadata struct {
...
type DeviceClassListConfig struct {
...
type DeviceClassListAttrs struct {
	AllowWatchBookmarks any
...
var DeviceClassList = ubx.DataSourceBinding{
