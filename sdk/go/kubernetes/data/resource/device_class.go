...
type DeviceClass_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type DeviceClass_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type DeviceClass_Items_Metadata struct {
	Annotations                any
...
type DeviceClass_Items_Spec_Config_Opaque struct {
	Driver     any
	Parameters any
}

type DeviceClass_Items_Spec_Config struct {
	Opaque any
}

type DeviceClass_Items_Spec_Selectors_Cel struct {
	Expression any
}

type DeviceClass_Items_Spec_Selectors struct {
	Cel any
}

type DeviceClass_Items_Spec struct {
	Config               any
	ExtendedResourceName any
	Selectors            any
}

type DeviceClass_Items struct {
	ApiVersion any
	Kind       any
	Metadata   any
	Spec       any
...
type DeviceClass_Metadata_ShardInfo struct {
...
var DeviceClass = ubx.DataSourceBinding{
