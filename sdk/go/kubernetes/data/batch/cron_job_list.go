...
type CronJobList_Items_Spec_JobTemplate_Spec_PodFailurePolicy struct {
	Rules any
}
...
type CronJobList_Items_Spec_JobTemplate_Spec_Scheduling_SchedulingConstraints_Topology struct {
	Key any
}

type CronJobList_Items_Spec_JobTemplate_Spec_Scheduling_SchedulingConstraints struct {
	Topology any
}

type CronJobList_Items_Spec_JobTemplate_Spec_Scheduling_SchedulingPolicy_Gang struct {
	MinCount any
}
...
type CronJobList_Items_Spec_JobTemplate_Spec_SuccessPolicy struct {
	Rules any
}
...
type CronJobList_Items_Spec_JobTemplate_Spec_Template_Spec_Containers_Lifecycle_PostStart_TcpSocket struct {
	Host any
	Port any
}
...
type CronJobList_Items_Spec_JobTemplate_Spec_Template_Spec_ReadinessGates struct {
	ConditionType any
}

type CronJobList_Items_Spec_JobTemplate_Spec_Template_Spec_SchedulingGroup struct {
	PodGroupName any
}
...
type CronJobList_Items_Spec_JobTemplate_Spec_Template_Spec_Volumes_Flocker struct {
	DatasetName any
	DatasetUuid any
}
...
type CronJobList_Items_Spec_JobTemplate_Spec_Template_Spec_Volumes_Projected_Sources_DownwardApi struct {
	Items any
}
...
type CronJobList_Metadata struct {
...
type CronJobListConfig struct {
}

type CronJobListAttrs struct {
