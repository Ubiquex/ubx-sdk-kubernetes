...
type ServiceAccount_Items_ImagePullSecrets struct {
	Name any
}

type ServiceAccount_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type ServiceAccount_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type ServiceAccount_Items_Metadata struct {
	Annotations                any
...
type ServiceAccount_Items_Secrets struct {
	ApiVersion      any
	FieldPath       any
	Kind            any
	Name            any
...
type ServiceAccount_Items struct {
	ApiVersion                   any
...
type ServiceAccount_Metadata_ShardInfo struct {
