...
type SecretList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type SecretList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type SecretList_Items_Metadata struct {
	Annotations any
...
type SecretList_Metadata_ShardInfo struct {
...
type SecretList_Metadata struct {
