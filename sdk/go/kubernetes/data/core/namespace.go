...
type Namespace_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type Namespace_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type Namespace_Items_Metadata struct {
	Annotations                any
...
type Namespace_Items_Spec struct {
	Finalizers any
}

type Namespace_Items_Status_Conditions struct {
...
type Namespace_Items_Status struct {
	Conditions any
	Phase      any
}

type Namespace_Items struct {
	ApiVersion any
	Kind       any
	Metadata   any
	Spec       any
...
type Namespace_Metadata_ShardInfo struct {
