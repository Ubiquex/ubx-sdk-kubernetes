...
type NamespaceList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type NamespaceList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type NamespaceList_Items_Metadata struct {
	Annotations any
...
type NamespaceList_Items_Spec struct {
	Finalizers any
}

type NamespaceList_Items_Status_Conditions struct {
...
type NamespaceList_Items_Status struct {
	Conditions any
	Phase any
}

type NamespaceList_Items struct {
	ApiVersion any
	Kind any
	Metadata any
	Spec any
...
type NamespaceList_Metadata_ShardInfo struct {
...
type NamespaceList_Metadata struct {
