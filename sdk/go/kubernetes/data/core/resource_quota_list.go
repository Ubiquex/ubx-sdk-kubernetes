...
type ResourceQuotaList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type ResourceQuotaList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type ResourceQuotaList_Items_Metadata struct {
	Annotations any
...
type ResourceQuotaList_Items_Spec_ScopeSelector_MatchExpressions struct {
	Operator any
	ScopeName any
	Values any
}

type ResourceQuotaList_Items_Spec_ScopeSelector struct {
	MatchExpressions any
}

type ResourceQuotaList_Items_Spec struct {
	Hard any
	ScopeSelector any
	Scopes any
}

type ResourceQuotaList_Items_Status struct {
	Hard any
	Used any
}

type ResourceQuotaList_Items struct {
	ApiVersion any
	Kind any
	Metadata any
	Spec any
...
type ResourceQuotaList_Metadata_ShardInfo struct {
...
type ResourceQuotaList_Metadata struct {
...
type ResourceQuotaListConfig struct {
...
type ResourceQuotaListAttrs struct {
	AllowWatchBookmarks any
...
var ResourceQuotaList = ubx.DataSourceBinding{
