...
type Secret_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type Secret_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type Secret_Items_Metadata struct {
	Annotations                any
...
type Secret_Metadata_ShardInfo struct {
