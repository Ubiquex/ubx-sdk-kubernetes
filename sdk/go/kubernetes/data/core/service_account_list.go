...
type ServiceAccountList_Items_ImagePullSecrets struct {
	Name any
}

type ServiceAccountList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type ServiceAccountList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type ServiceAccountList_Items_Metadata struct {
	Annotations any
...
type ServiceAccountList_Items_Secrets struct {
	ApiVersion any
	FieldPath any
	Kind any
	Name any
...
type ServiceAccountList_Items struct {
	ApiVersion any
...
type ServiceAccountList_Metadata_ShardInfo struct {
...
type ServiceAccountList_Metadata struct {
...
type ServiceAccountListConfig struct {
...
type ServiceAccountListAttrs struct {
	AllowWatchBookmarks any
...
var ServiceAccountList = ubx.DataSourceBinding{
