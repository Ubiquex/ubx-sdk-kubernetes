...
type Role_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type Role_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type Role_Items_Metadata struct {
	Annotations                any
...
type Role_Metadata_ShardInfo struct {
