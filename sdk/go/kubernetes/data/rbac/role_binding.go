...
type RoleBinding_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type RoleBinding_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type RoleBinding_Items_Metadata struct {
	Annotations                any
...
type RoleBinding_Items_RoleRef struct {
	ApiGroup any
	Kind     any
	Name     any
}

type RoleBinding_Items_Subjects struct {
	ApiGroup  any
	Kind      any
	Name      any
	Namespace any
...
type RoleBinding_Metadata_ShardInfo struct {
...
var RoleBinding = ubx.DataSourceBinding{
