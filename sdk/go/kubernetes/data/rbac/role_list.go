...
type RoleList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type RoleList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type RoleList_Items_Metadata struct {
	Annotations any
...
type RoleList_Items_Rules struct {
	ApiGroups any
	NonResourceUrls any
	ResourceNames any
	Resources any
...
type RoleList_Metadata_ShardInfo struct {
