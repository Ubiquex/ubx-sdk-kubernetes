...
type RoleBindingList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type RoleBindingList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type RoleBindingList_Items_Metadata struct {
	Annotations any
...
type RoleBindingList_Items_RoleRef struct {
	ApiGroup any
	Kind any
	Name any
}

type RoleBindingList_Items_Subjects struct {
	ApiGroup any
	Kind any
	Name any
	Namespace any
...
type RoleBindingList_Items struct {
	ApiVersion any
	Kind any
	Metadata any
	RoleRef any
...
type RoleBindingList_Metadata_ShardInfo struct {
...
type RoleBindingList_Metadata struct {
...
type RoleBindingListConfig struct {
...
type RoleBindingListAttrs struct {
	AllowWatchBookmarks any
...
var RoleBindingList = ubx.DataSourceBinding{
