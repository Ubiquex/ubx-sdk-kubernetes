...
type ClusterRoleBinding_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type ClusterRoleBinding_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type ClusterRoleBinding_Items_Metadata struct {
	Annotations                any
...
type ClusterRoleBinding_Items_RoleRef struct {
	ApiGroup any
	Kind     any
	Name     any
}

type ClusterRoleBinding_Items_Subjects struct {
	ApiGroup  any
	Kind      any
	Name      any
	Namespace any
...
type ClusterRoleBinding_Items struct {
	ApiVersion any
	Kind       any
	Metadata   any
	RoleRef    any
...
type ClusterRoleBinding_Metadata_ShardInfo struct {
...
var ClusterRoleBinding = ubx.DataSourceBinding{
