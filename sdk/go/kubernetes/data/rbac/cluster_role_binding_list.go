...
type ClusterRoleBindingList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type ClusterRoleBindingList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type ClusterRoleBindingList_Items_Metadata struct {
	Annotations any
...
type ClusterRoleBindingList_Items_RoleRef struct {
	ApiGroup any
	Kind any
	Name any
}

type ClusterRoleBindingList_Items_Subjects struct {
	ApiGroup any
	Kind any
	Name any
	Namespace any
...
type ClusterRoleBindingList_Items struct {
	ApiVersion any
	Kind any
	Metadata any
	RoleRef any
...
type ClusterRoleBindingList_Metadata_ShardInfo struct {
...
type ClusterRoleBindingList_Metadata struct {
...
type ClusterRoleBindingListConfig struct {
...
type ClusterRoleBindingListAttrs struct {
	AllowWatchBookmarks any
...
var ClusterRoleBindingList = ubx.DataSourceBinding{
