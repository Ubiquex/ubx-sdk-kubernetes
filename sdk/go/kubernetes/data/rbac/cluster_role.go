...
type ClusterRole_Items_AggregationRule_ClusterRoleSelectors_MatchExpressions struct {
	Key      any
	Operator any
	Values   any
}

type ClusterRole_Items_AggregationRule_ClusterRoleSelectors struct {
	MatchExpressions any
	MatchLabels      any
}

type ClusterRole_Items_AggregationRule struct {
	ClusterRoleSelectors any
}

type ClusterRole_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type ClusterRole_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type ClusterRole_Items_Metadata struct {
	Annotations                any
...
type ClusterRole_Items_Rules struct {
	ApiGroups       any
	NonResourceUrls any
	ResourceNames   any
	Resources       any
...
type ClusterRole_Metadata_ShardInfo struct {
...
var ClusterRole = ubx.DataSourceBinding{
