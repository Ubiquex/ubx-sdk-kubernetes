...
type RuntimeClass_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type RuntimeClass_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type RuntimeClass_Items_Metadata struct {
	Annotations                any
...
type RuntimeClass_Items_Overhead struct {
	PodFixed any
}

type RuntimeClass_Items_Scheduling_Tolerations struct {
	Effect            any
	Key               any
	Operator          any
...
type RuntimeClass_Items_Scheduling struct {
	NodeSelector any
	Tolerations  any
}

type RuntimeClass_Items struct {
	ApiVersion any
	Handler    any
	Kind       any
	Metadata   any
...
type RuntimeClass_Metadata_ShardInfo struct {
...
var RuntimeClass = ubx.DataSourceBinding{
