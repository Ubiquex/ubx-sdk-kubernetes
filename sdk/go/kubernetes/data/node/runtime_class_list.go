...
type RuntimeClassList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type RuntimeClassList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type RuntimeClassList_Items_Metadata struct {
	Annotations any
...
type RuntimeClassList_Items_Overhead struct {
	PodFixed any
}

type RuntimeClassList_Items_Scheduling_Tolerations struct {
	Effect any
	Key any
	Operator any
...
type RuntimeClassList_Items_Scheduling struct {
	NodeSelector any
	Tolerations any
}

type RuntimeClassList_Items struct {
	ApiVersion any
	Handler any
	Kind any
	Metadata any
...
type RuntimeClassList_Metadata_ShardInfo struct {
...
type RuntimeClassList_Metadata struct {
...
type RuntimeClassListConfig struct {
...
type RuntimeClassListAttrs struct {
	AllowWatchBookmarks any
...
var RuntimeClassList = ubx.DataSourceBinding{
