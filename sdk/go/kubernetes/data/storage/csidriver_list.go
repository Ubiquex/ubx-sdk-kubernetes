...
type CsidriverList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type CsidriverList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type CsidriverList_Items_Metadata struct {
	Annotations any
...
type CsidriverList_Items_Spec_TokenRequests struct {
	Audience any
	ExpirationSeconds any
}

type CsidriverList_Items_Spec struct {
	AttachRequired any
	FsGroupPolicy any
...
type CsidriverList_Items struct {
	ApiVersion any
	Kind any
	Metadata any
	Spec any
...
type CsidriverList_Metadata_ShardInfo struct {
...
type CsidriverList_Metadata struct {
...
type CsidriverListConfig struct {
...
type CsidriverListAttrs struct {
	AllowWatchBookmarks any
...
var CsidriverList = ubx.DataSourceBinding{
