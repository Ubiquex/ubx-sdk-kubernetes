...
type Csidriver_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type Csidriver_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type Csidriver_Items_Metadata struct {
	Annotations                any
...
type Csidriver_Items_Spec_TokenRequests struct {
	Audience          any
	ExpirationSeconds any
}

type Csidriver_Items_Spec struct {
	AttachRequired                     any
	FsGroupPolicy                      any
...
type Csidriver_Metadata_ShardInfo struct {
...
var Csidriver = ubx.DataSourceBinding{
