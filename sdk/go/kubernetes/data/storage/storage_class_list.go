...
type StorageClassList_Items_AllowedTopologies_MatchLabelExpressions struct {
	Key any
	Values any
}

type StorageClassList_Items_AllowedTopologies struct {
	MatchLabelExpressions any
}

type StorageClassList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type StorageClassList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type StorageClassList_Items_Metadata struct {
	Annotations any
...
type StorageClassList_Items struct {
...
type StorageClassList_Metadata_ShardInfo struct {
...
type StorageClassList_Metadata struct {
...
type StorageClassListConfig struct {
...
type StorageClassListAttrs struct {
	AllowWatchBookmarks any
...
var StorageClassList = ubx.DataSourceBinding{
