...
type VolumeAttributesClass_Items_Metadata_ManagedFields struct {
	ApiVersion  any
	FieldsType  any
	FieldsV1    any
	Manager     any
...
type VolumeAttributesClass_Items_Metadata_OwnerReferences struct {
	ApiVersion         any
...
type VolumeAttributesClass_Items_Metadata struct {
	Annotations                any
...
type VolumeAttributesClass_Items struct {
	ApiVersion any
	DriverName any
	Kind       any
	Metadata   any
...
type VolumeAttributesClass_Metadata_ShardInfo struct {
...
var VolumeAttributesClass = ubx.DataSourceBinding{
