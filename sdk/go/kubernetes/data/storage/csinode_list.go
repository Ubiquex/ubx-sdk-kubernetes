...
type CsinodeList_Items_Metadata_ManagedFields struct {
	ApiVersion any
	FieldsType any
	FieldsV1 any
	Manager any
...
type CsinodeList_Items_Metadata_OwnerReferences struct {
	ApiVersion any
...
type CsinodeList_Items_Metadata struct {
	Annotations any
...
type CsinodeList_Items_Spec_Drivers_Allocatable struct {
	Count any
}

type CsinodeList_Items_Spec_Drivers struct {
	Allocatable any
	Name any
	NodeId any
	TopologyKeys any
...
type CsinodeList_Items_Spec struct {
	Drivers any
}

type CsinodeList_Items_Status_StorageHealth_HealthConditions struct {
	AccessMode any
...
type CsinodeList_Items_Status_StorageHealth struct {
	HealthConditions any
	Name any
}

type CsinodeList_Items_Status struct {
	StorageHealth any
}

type CsinodeList_Items struct {
	ApiVersion any
	Kind any
	Metadata any
	Spec any
...
type CsinodeList_Metadata_ShardInfo struct {
...
type CsinodeList_Metadata struct {
...
var CsinodeList = ubx.DataSourceBinding{
