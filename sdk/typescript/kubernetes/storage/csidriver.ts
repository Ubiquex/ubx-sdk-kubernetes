...
export interface Csidriver_Metadata_ManagedFields {
...
export interface Csidriver_Metadata_OwnerReferences {
...
export interface Csidriver_Metadata {
  ...
  managedFields?: Csidriver_Metadata_ManagedFields[] | Computed<Csidriver_Metadata_ManagedFields[]>;
  ...
  ownerReferences?: Csidriver_Metadata_OwnerReferences[] | Computed<Csidriver_Metadata_OwnerReferences[]>;
...
export interface Csidriver_Spec_TokenRequests {
...
export interface Csidriver_Spec {
  ...
  fsGroupPolicy?: string | Computed<string>;
  ...
  nodeAllocatableUpdatePeriodSeconds?: number | Computed<number>;
  ...
  preventPodSchedulingIfMissing?: boolean | Computed<boolean>;
  ...
  requiresRepublish?: boolean | Computed<boolean>;
  ...
  seLinuxMount?: boolean | Computed<boolean>;
  ...
  serviceAccountTokenInSecrets?: boolean | Computed<boolean>;
  ...
  storageCapacity?: boolean | Computed<boolean>;
  ...
  tokenRequests?: Csidriver_Spec_TokenRequests[] | Computed<Csidriver_Spec_TokenRequests[]>;
...
const Csidriver_Metadata_ManagedFieldsFields: FieldMap = {
...
const Csidriver_Metadata_OwnerReferencesFields: FieldMap = {
  apiVersion: "api_version",
...
const Csidriver_MetadataFields: FieldMap = {
...
const Csidriver_Spec_TokenRequestsFields: FieldMap = {
  audience: "audience",
  expirationSeconds: "expiration_seconds",
};

const Csidriver_SpecFields: FieldMap = {
  attachRequired: "attach_required",
  fsGroupPolicy: "fs_group_policy",
  nodeAllocatableUpdatePeriodSeconds: "node_allocatable_update_period_seconds",
  podInfoOnMount: "pod_info_on_mount",
  preventPodSchedulingIfMissing: "prevent_pod_scheduling_if_missing",
  requiresRepublish: "requires_republish",
  seLinuxMount: "se_linux_mount",
  serviceAccountTokenInSecrets: "service_account_token_in_secrets",
...
export interface CsidriverConfig {
  ...
  metadata?: Csidriver_Metadata | Computed<Csidriver_Metadata>;
  /** CSIDriverSpec is the specification of a CSIDriver. */
  spec: Csidriver_Spec | Computed<Csidriver_Spec>;
  /** path parameter, not part of the API's own resource representation */
  name: string | Computed<string>;
}

export interface CsidriverAttrs {
  /** APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources */
  apiVersion: string;
  /** Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds */
  kind: string;
  /** ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create. */
  metadata: Csidriver_Metadata;
  /** CSIDriverSpec is the specification of a CSIDriver. */
  spec: Csidriver_Spec;
  /** path parameter, not part of the API's own resource representation */
  name: string;
...
export const Csidriver: ResourceBinding<CsidriverConfig, CsidriverAttrs> = {
