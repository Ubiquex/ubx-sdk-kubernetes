// Code generated by `ubx sdk gen` from kubernetes_meta_watch_event. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface WatchEventConfig {
}

export interface WatchEventAttrs {
...
export const WatchEvent: DataSourceBinding<WatchEventConfig, WatchEventAttrs> = {
  wireType: "kubernetes_meta_watch_event",
  fields: {
  },
};
