...
export interface V1beta2DeviceTaintRule_Metadata_ManagedFields {
...
export interface V1beta2DeviceTaintRule_Metadata_OwnerReferences {
...
export interface V1beta2DeviceTaintRule_Metadata {
  ...
  managedFields?: V1beta2DeviceTaintRule_Metadata_ManagedFields[] | Computed<V1beta2DeviceTaintRule_Metadata_ManagedFields[]>;
  ...
  ownerReferences?: V1beta2DeviceTaintRule_Metadata_OwnerReferences[] | Computed<V1beta2DeviceTaintRule_Metadata_OwnerReferences[]>;
...
export interface V1beta2DeviceTaintRule_Spec_DeviceSelector {
...
export interface V1beta2DeviceTaintRule_Spec_Taint {
...
export interface V1beta2DeviceTaintRule_Spec {
  /** DeviceTaintSelector defines which device(s) a DeviceTaintRule applies to. The empty selector matches all devices. Without a selector, no devices are matched. */
  deviceSelector?: V1beta2DeviceTaintRule_Spec_DeviceSelector | Computed<V1beta2DeviceTaintRule_Spec_DeviceSelector>;
  /** The device this taint is attached to has the "effect" on any claim which does not tolerate the taint and, through the claim, to pods using the claim. */
  taint: V1beta2DeviceTaintRule_Spec_Taint | Computed<V1beta2DeviceTaintRule_Spec_Taint>;
}

export interface V1beta2DeviceTaintRule_Status_Conditions {
...
export interface V1beta2DeviceTaintRule_Status {
  ...
  conditions?: V1beta2DeviceTaintRule_Status_Conditions[] | Computed<V1beta2DeviceTaintRule_Status_Conditions[]>;
}

const V1beta2DeviceTaintRule_Metadata_ManagedFieldsFields: FieldMap = {
...
const V1beta2DeviceTaintRule_Metadata_OwnerReferencesFields: FieldMap = {
  apiVersion: "api_version",
...
const V1beta2DeviceTaintRule_MetadataFields: FieldMap = {
  ...
  managedFields: {
    ...
    kind: "list",
    fields: V1beta2DeviceTaintRule_Metadata_ManagedFieldsFields,
  },
  name: "name",
  namespace: "namespace",
  ownerReferences: {
    ...
    kind: "list",
    fields: V1beta2DeviceTaintRule_Metadata_OwnerReferencesFields,
  },
...
const V1beta2DeviceTaintRule_Spec_DeviceSelectorFields: FieldMap = {
  device: "device",
  driver: "driver",
  pool: "pool",
};

const V1beta2DeviceTaintRule_Spec_TaintFields: FieldMap = {
  effect: "effect",
  key: "key",
...
const V1beta2DeviceTaintRule_SpecFields: FieldMap = {
  deviceSelector: {
    wireName: "device_selector",
    kind: "object",
    fields: V1beta2DeviceTaintRule_Spec_DeviceSelectorFields,
  },
  taint: {
    wireName: "taint",
    kind: "object",
    fields: V1beta2DeviceTaintRule_Spec_TaintFields,
  },
};

const V1beta2DeviceTaintRule_Status_ConditionsFields: FieldMap = {
...
const V1beta2DeviceTaintRule_StatusFields: FieldMap = {
  conditions: {
    wireName: "conditions",
    kind: "list",
    fields: V1beta2DeviceTaintRule_Status_ConditionsFields,
  },
};

export interface V1beta2DeviceTaintRuleConfig {
  ...
  metadata?: V1beta2DeviceTaintRule_Metadata | Computed<V1beta2DeviceTaintRule_Metadata>;
  /** DeviceTaintRuleSpec specifies the selector and one taint. */
  spec: V1beta2DeviceTaintRule_Spec | Computed<V1beta2DeviceTaintRule_Spec>;
  /** DeviceTaintRuleStatus provides information about an on-going pod eviction. */
  status?: V1beta2DeviceTaintRule_Status | Computed<V1beta2DeviceTaintRule_Status>;
  /** path parameter, not part of the API's own resource representation */
  name: string | Computed<string>;
}

export interface V1beta2DeviceTaintRuleAttrs {
  /** APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources */
  apiVersion: string;
  /** Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds */
  kind: string;
  /** ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create. */
  metadata: V1beta2DeviceTaintRule_Metadata;
  /** DeviceTaintRuleSpec specifies the selector and one taint. */
  spec: V1beta2DeviceTaintRule_Spec;
  /** DeviceTaintRuleStatus provides information about an on-going pod eviction. */
  status: V1beta2DeviceTaintRule_Status;
  /** path parameter, not part of the API's own resource representation */
  name: string;
}

export const V1beta2DeviceTaintRule: ResourceBinding<V1beta2DeviceTaintRuleConfig, V1beta2DeviceTaintRuleAttrs> = {
  wireType: "kubernetes_resource_v1beta2_device_taint_rule",
  fields: {
    apiVersion: "api_version",
    kind: "kind",
    metadata: {
      wireName: "metadata",
      kind: "object",
      fields: V1beta2DeviceTaintRule_MetadataFields,
    },
    spec: {
      wireName: "spec",
      kind: "object",
      fields: V1beta2DeviceTaintRule_SpecFields,
    },
    status: {
      wireName: "status",
      kind: "object",
      fields: V1beta2DeviceTaintRule_StatusFields,
    },
    name: "name",
  },
};
