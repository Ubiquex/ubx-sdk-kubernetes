// Code generated by `ubx sdk gen` from kubernetes_resource_v1beta2_device_class. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta2DeviceClass_Metadata_ManagedFields {
...
export interface V1beta2DeviceClass_Metadata_OwnerReferences {
...
export interface V1beta2DeviceClass_Metadata {
  ...
  managedFields?: V1beta2DeviceClass_Metadata_ManagedFields[] | Computed<V1beta2DeviceClass_Metadata_ManagedFields[]>;
  ...
  ownerReferences?: V1beta2DeviceClass_Metadata_OwnerReferences[] | Computed<V1beta2DeviceClass_Metadata_OwnerReferences[]>;
...
export interface V1beta2DeviceClass_Spec_Config_Opaque {
...
export interface V1beta2DeviceClass_Spec_Config {
  /** Provides driver-specific settings for a device class that are opaque to the Kubernetes scheduler. (AI-inferred) */
  opaque?: V1beta2DeviceClass_Spec_Config_Opaque | Computed<V1beta2DeviceClass_Spec_Config_Opaque>;
}

export interface V1beta2DeviceClass_Spec_Selectors_Cel {
...
export interface V1beta2DeviceClass_Spec_Selectors {
  ...
  cel?: V1beta2DeviceClass_Spec_Selectors_Cel | Computed<V1beta2DeviceClass_Spec_Selectors_Cel>;
}

export interface V1beta2DeviceClass_Spec {
  ...
  config?: V1beta2DeviceClass_Spec_Config[] | Computed<V1beta2DeviceClass_Spec_Config[]>;
  ...
  selectors?: V1beta2DeviceClass_Spec_Selectors[] | Computed<V1beta2DeviceClass_Spec_Selectors[]>;
}

const V1beta2DeviceClass_Metadata_ManagedFieldsFields: FieldMap = {
...
const V1beta2DeviceClass_Metadata_OwnerReferencesFields: FieldMap = {
  apiVersion: "api_version",
...
const V1beta2DeviceClass_MetadataFields: FieldMap = {
...
const V1beta2DeviceClass_Spec_Config_OpaqueFields: FieldMap = {
  driver: "driver",
  parameters: "parameters",
};

const V1beta2DeviceClass_Spec_ConfigFields: FieldMap = {
  opaque: {
    wireName: "opaque",
    kind: "object",
...
const V1beta2DeviceClass_Spec_Selectors_CelFields: FieldMap = {
  expression: "expression",
};

const V1beta2DeviceClass_Spec_SelectorsFields: FieldMap = {
  cel: {
    wireName: "cel",
    kind: "object",
...
const V1beta2DeviceClass_SpecFields: FieldMap = {
  config: {
    wireName: "config",
    kind: "list",
...
export interface V1beta2DeviceClassConfig {
  ...
  metadata?: V1beta2DeviceClass_Metadata | Computed<V1beta2DeviceClass_Metadata>;
  /** DeviceClassSpec is used in a [DeviceClass] to define what can be allocated and how to configure it. */
  spec?: V1beta2DeviceClass_Spec | Computed<V1beta2DeviceClass_Spec>;
  /** path parameter, not part of the API's own resource representation */
  name: string | Computed<string>;
}

export interface V1beta2DeviceClassAttrs {
  /** APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources */
  apiVersion: string;
  /** Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds */
  kind: string;
  /** ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create. */
  metadata: V1beta2DeviceClass_Metadata;
  /** DeviceClassSpec is used in a [DeviceClass] to define what can be allocated and how to configure it. */
  spec: V1beta2DeviceClass_Spec;
  /** path parameter, not part of the API's own resource representation */
  name: string;
}

export const V1beta2DeviceClass: ResourceBinding<V1beta2DeviceClassConfig, V1beta2DeviceClassAttrs> = {
