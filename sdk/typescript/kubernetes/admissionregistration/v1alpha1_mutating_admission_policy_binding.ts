// Code generated by `ubx sdk gen` from kubernetes_admissionregistration_v1alpha1_mutating_admission_policy_binding. DO NOT EDIT.
...
export interface V1alpha1MutatingAdmissionPolicyBinding_Metadata {
  ...
  managedFields?: V1alpha1MutatingAdmissionPolicyBinding_Metadata_ManagedFields[] | Computed<V1alpha1MutatingAdmissionPolicyBinding_Metadata_ManagedFields[]>;
  ...
  ownerReferences?: V1alpha1MutatingAdmissionPolicyBinding_Metadata_OwnerReferences[] | Computed<V1alpha1MutatingAdmissionPolicyBinding_Metadata_OwnerReferences[]>;
...
export interface V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelector {
  /** matchExpressions is a list of label selector requirements. The requirements are ANDed. */
  matchExpressions?: V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelector_MatchExpressions[] | Computed<V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelector_MatchExpressions[]>;
  /** matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed. */
  matchLabels?: Record<string, string> | Computed<Record<string, string>>;
}

export interface V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources {
  ...
  excludeResourceRules?: V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_ExcludeResourceRules[] | Computed<V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_ExcludeResourceRules[]>;
  ...
  namespaceSelector?: V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelector | Computed<V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelector>;
  /** A label selector is a label query over a set of resources. The result of matchLabels and matchExpressions are ANDed. An empty label selector matches all objects. A null label selector matches no objects. */
  objectSelector?: V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelector | Computed<V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelector>;
  ...
  resourceRules?: V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_ExcludeResourceRules[] | Computed<V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_ExcludeResourceRules[]>;
}

export interface V1alpha1MutatingAdmissionPolicyBinding_Spec_ParamRef {
  ...
  /** A label selector is a label query over a set of resources. The result of matchLabels and matchExpressions are ANDed. An empty label selector matches all objects. A null label selector matches no objects. */
  selector?: V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelector | Computed<V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelector>;
}

export interface V1alpha1MutatingAdmissionPolicyBinding_Spec {
  /** MatchResources decides whether to run the admission control policy on an object based on whether it meets the match criteria. The exclude rules take precedence over include rules (if a resource matches both, it is excluded) */
  matchResources?: V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources | Computed<V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources>;
  /** ParamRef describes how to locate the params to be used as input to expressions of rules applied by a policy binding. */
  paramRef?: V1alpha1MutatingAdmissionPolicyBinding_Spec_ParamRef | Computed<V1alpha1MutatingAdmissionPolicyBinding_Spec_ParamRef>;
...
const V1alpha1MutatingAdmissionPolicyBinding_Metadata_ManagedFieldsFields: FieldMap = {
...
const V1alpha1MutatingAdmissionPolicyBinding_Metadata_OwnerReferencesFields: FieldMap = {
  apiVersion: "api_version",
...
const V1alpha1MutatingAdmissionPolicyBinding_MetadataFields: FieldMap = {
  ...
  managedFields: {
    ...
    kind: "list",
    fields: V1alpha1MutatingAdmissionPolicyBinding_Metadata_ManagedFieldsFields,
  },
  name: "name",
  namespace: "namespace",
  ownerReferences: {
    ...
    kind: "list",
    fields: V1alpha1MutatingAdmissionPolicyBinding_Metadata_OwnerReferencesFields,
  },
...
const V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_ExcludeResourceRulesFields: FieldMap = {
...
const V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelector_MatchExpressionsFields: FieldMap = {
  key: "key",
  operator: "operator",
  values: "values",
};

const V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelectorFields: FieldMap = {
  matchExpressions: {
    wireName: "match_expressions",
    kind: "list",
    fields: V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelector_MatchExpressionsFields,
  },
  matchLabels: "match_labels",
};

const V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResourcesFields: FieldMap = {
  excludeResourceRules: {
    wireName: "exclude_resource_rules",
    kind: "list",
    fields: V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_ExcludeResourceRulesFields,
  },
  matchPolicy: "match_policy",
  namespaceSelector: {
    wireName: "namespace_selector",
    kind: "object",
    fields: V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResources_NamespaceSelectorFields,
  },
  objectSelector: {
...
const V1alpha1MutatingAdmissionPolicyBinding_Spec_ParamRefFields: FieldMap = {
  name: "name",
  namespace: "namespace",
...
const V1alpha1MutatingAdmissionPolicyBinding_SpecFields: FieldMap = {
  matchResources: {
    wireName: "match_resources",
    kind: "object",
    fields: V1alpha1MutatingAdmissionPolicyBinding_Spec_MatchResourcesFields,
  },
  paramRef: {
    wireName: "param_ref",
    kind: "object",
    fields: V1alpha1MutatingAdmissionPolicyBinding_Spec_ParamRefFields,
  },
  policyName: "policy_name",
};

export interface V1alpha1MutatingAdmissionPolicyBindingConfig {
  ...
  metadata?: V1alpha1MutatingAdmissionPolicyBinding_Metadata | Computed<V1alpha1MutatingAdmissionPolicyBinding_Metadata>;
  /** MutatingAdmissionPolicyBindingSpec is the specification of the MutatingAdmissionPolicyBinding. */
  spec?: V1alpha1MutatingAdmissionPolicyBinding_Spec | Computed<V1alpha1MutatingAdmissionPolicyBinding_Spec>;
  /** path parameter, not part of the API's own resource representation */
  name: string | Computed<string>;
}

export interface V1alpha1MutatingAdmissionPolicyBindingAttrs {
  /** APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources */
  apiVersion: string;
  /** Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds */
  kind: string;
  /** ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create. */
  metadata: V1alpha1MutatingAdmissionPolicyBinding_Metadata;
  /** MutatingAdmissionPolicyBindingSpec is the specification of the MutatingAdmissionPolicyBinding. */
  spec: V1alpha1MutatingAdmissionPolicyBinding_Spec;
  /** path parameter, not part of the API's own resource representation */
  name: string;
}

export const V1alpha1MutatingAdmissionPolicyBinding: ResourceBinding<V1alpha1MutatingAdmissionPolicyBindingConfig, V1alpha1MutatingAdmissionPolicyBindingAttrs> = {
  wireType: "kubernetes_admissionregistration_v1alpha1_mutating_admission_policy_binding",
  fields: {
    apiVersion: "api_version",
    kind: "kind",
    metadata: {
      wireName: "metadata",
      kind: "object",
      fields: V1alpha1MutatingAdmissionPolicyBinding_MetadataFields,
    },
    spec: {
      wireName: "spec",
      kind: "object",
      fields: V1alpha1MutatingAdmissionPolicyBinding_SpecFields,
    },
    name: "name",
  },
};
